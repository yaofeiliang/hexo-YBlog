---
title: "[行业观察] Solana Testnet - v1.9.7：热闹背后的规则变化"
date: 2022-02-17 10:00:00
updated: 2022-02-17 10:00:00
description: "区块链领域关键节点：Solana Testnet - v1.9.7。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2022/blockchain-blockchain-solana-solana-testnet-v1-9-7/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v1.9.7
source_published: 2022-02-17
...
Solana 在 **2022-02-17** 留下了一条可核对的公开记录：**Solana Testnet - v1.9.7**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2022-02-17
- **主体：** Solana
- **事件：** Solana Testnet - v1.9.7
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v1.9.7)
...
- 原始日期：2022-02-17
- 收录月份：2022-02
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v1.9.7>
