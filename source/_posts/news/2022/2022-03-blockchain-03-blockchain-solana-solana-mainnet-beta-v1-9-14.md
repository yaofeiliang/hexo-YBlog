---
title: "[行业观察] Solana Mainnet Beta - v1.9.14：热闹背后的规则变化"
date: 2022-03-26 10:00:00
updated: 2022-03-26 10:00:00
description: "区块链领域关键节点：Solana Mainnet Beta - v1.9.14。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2022/blockchain-blockchain-solana-solana-mainnet-beta-v1-9-14/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v1.9.14
...
Solana 在 **2022-03-26** 留下了一条可核对的公开记录：**Solana Mainnet Beta - v1.9.14**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2022-03-26
- **主体：** Solana
- **事件：** Solana Mainnet Beta - v1.9.14
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v1.9.14)

根据可核验公开材料，关键信息可以概括为：

- Doc improvements
- Add getconfirmedblockswithdata method
...
- 原始日期：2022-03-26
- 收录月份：2022-03
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v1.9.14>
