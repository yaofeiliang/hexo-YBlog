---
title: "[行业观察] go-ethereum Vectra (v1.10.20)：热闹背后的规则变化"
date: 2022-06-29 10:00:00
updated: 2022-06-29 10:00:00
description: "区块链领域关键节点：go-ethereum Vectra (v1.10.20)。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2022/blockchain-blockchain-go-ethereum-go-ethereum-vectra-v1-10-20/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/ethereum/go-ethereum/releases/tag/v1.10.20
source_published: 2022-06-29
...
go-ethereum 在 **2022-06-29** 留下了一条可核对的公开记录：**go-ethereum Vectra (v1.10.20)**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2022-06-29
- **主体：** go-ethereum
- **事件：** go-ethereum Vectra (v1.10.20)
- **一手入口：** [点这里看原文](https://github.com/ethereum/go-ethereum/releases/tag/v1.10.20)
...
- 原始日期：2022-06-29
- 收录月份：2022-06
- 一手链接：<https://github.com/ethereum/go-ethereum/releases/tag/v1.10.20>
