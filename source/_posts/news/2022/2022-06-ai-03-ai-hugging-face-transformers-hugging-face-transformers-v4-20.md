---
title: "[行业观察] Hugging Face Transformers # v4.20.1 Patch release：这次更新到底动了谁的奶酪"
date: 2022-06-21 10:00:00
updated: 2022-06-21 10:00:00
description: "人工智能领域关键节点：Hugging Face Transformers # v4.20.1 Patch release。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
...
source_url: https://github.com/huggingface/transformers/releases/tag/v4.20.1
source_published: 2022-06-21
...
又到了把咖啡放下、把官方链接点开的时刻：Hugging Face Transformers # v4.20.1 Patch release。

Hugging Face Transformers 在 **2022-06-21** 留下了一条可核对的公开记录：**Hugging Face Transformers # v4.20.1 Patch release**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **事件：** Hugging Face Transformers # v4.20.1 Patch release
- **一手入口：** [点这里看原文](https://github.com/huggingface/transformers/releases/tag/v4.20.1)

根据可核验公开材料，关键信息可以概括为：

- Add finallayernorm to OPT model 17785
...
- 原始日期：2022-06-21
- 收录月份：2022-06
- 一手链接：<https://github.com/huggingface/transformers/releases/tag/v4.20.1>
