---
title: "[行业观察] TensorFlow TensorFlow 2.11.0：这次更新到底动了谁的奶酪"
date: 2022-11-18 10:00:00
updated: 2022-11-18 10:00:00
description: "人工智能领域关键节点：TensorFlow TensorFlow 2.11.0。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2022/ai-ai-tensorflow-tensorflow-tensorflow-2-11-0/
categories:
  - 资讯
tags:
  - 行业资讯
...
又到了把咖啡放下、把官方链接点开的时刻：TensorFlow TensorFlow 2.11.0。

TensorFlow 在 **2022-11-18** 留下了一条可核对的公开记录：**TensorFlow TensorFlow 2.11.0**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **一手入口：** [点这里看原文](https://github.com/tensorflow/tensorflow/releases/tag/v2.11.0)
