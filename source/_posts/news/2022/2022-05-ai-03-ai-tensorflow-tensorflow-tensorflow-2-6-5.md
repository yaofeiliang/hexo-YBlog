---
title: "[行业观察] TensorFlow TensorFlow 2.6.5：这次更新到底动了谁的奶酪"
date: 2022-05-23 10:00:00
updated: 2022-05-23 10:00:00
description: "人工智能领域关键节点：TensorFlow TensorFlow 2.6.5。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2022/ai-ai-tensorflow-tensorflow-tensorflow-2-6-5/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/tensorflow/tensorflow/releases/tag/v2.6.5
source_published: 2022-05-23
...
如果说 AI 是一场连续剧，那么「TensorFlow TensorFlow 2.6.5」就是那集人人都在刷弹幕的高潮。

TensorFlow 在 **2022-05-23** 留下了一条可核对的公开记录：**TensorFlow TensorFlow 2.6.5**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **时间：** 2022-05-23
- **主体：** TensorFlow
- **事件：** TensorFlow TensorFlow 2.6.5
- **一手入口：** [点这里看原文](https://github.com/tensorflow/tensorflow/releases/tag/v2.6.5)

根据可核验公开材料，关键信息可以概括为：

- Release 2.6.5 Add an upper bound for protobuf in setup.py since protobuf after version 3.20 is currently incompatible with TensorFlow.
- See https://github.com/tensorflow/tensorflow/issues/53234, https://github.com/protocolbuffers/protobuf/issues/9954 and https://github.com/tensorflow/tensorflow/issues/56077.
...
- 原始日期：2022-05-23
- 收录月份：2022-05
- 一手链接：<https://github.com/tensorflow/tensorflow/releases/tag/v2.6.5>
