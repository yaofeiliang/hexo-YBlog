---
title: "[行业观察] TensorFlow TensorFlow 2.10.0-rc3：这次更新到底动了谁的奶酪"
date: 2022-08-29 10:00:00
updated: 2022-08-29 10:00:00
description: "人工智能领域关键节点：TensorFlow TensorFlow 2.10.0-rc3。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2022/ai-ai-tensorflow-tensorflow-tensorflow-2-10-0-rc3/
categories:
  - 资讯
tags:
  - 行业资讯
...
TensorFlow 在 **2022-08-29** 留下了一条可核对的公开记录：**TensorFlow TensorFlow 2.10.0-rc3**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **一手入口：** [点这里看原文](https://github.com/tensorflow/tensorflow/releases/tag/v2.10.0-rc3)

根据可核验公开材料，关键信息可以概括为：

- Causal attention in keras.layers.Attention and keras.layers.AdditiveAttention is now specified in the call() method via the usecausalmask argument (rather than in the constructor), for consistency with other layers.
