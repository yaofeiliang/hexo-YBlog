---
title: "[行业观察] PyTorch PyTorch 1.13.1 Release, small bug fix release：这次更新到底动了谁的奶酪"
date: 2022-12-16 10:00:00
updated: 2022-12-16 10:00:00
description: "人工智能领域关键节点：PyTorch PyTorch 1.13.1 Release, small bug fix release。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2022/ai-ai-pytorch-pytorch-pytorch-1-13-1-release-small-bug-fix-rele/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/pytorch/pytorch/releases/tag/v1.13.1
source_published: 2022-12-16
...
PyTorch 在 **2022-12-16** 留下了一条可核对的公开记录：**PyTorch PyTorch 1.13.1 Release, small bug fix release**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **时间：** 2022-12-16
- **主体：** PyTorch
- **事件：** PyTorch PyTorch 1.13.1 Release, small bug fix release
- **一手入口：** [点这里看原文](https://github.com/pytorch/pytorch/releases/tag/v1.13.1)

根据可核验公开材料，关键信息可以概括为：

- RuntimeError by torch.nn.modules.activation.MultiheadAttention with bias=False and batchfirst=True 88669
...
- 原始日期：2022-12-16
- 收录月份：2022-12
- 一手链接：<https://github.com/pytorch/pytorch/releases/tag/v1.13.1>
