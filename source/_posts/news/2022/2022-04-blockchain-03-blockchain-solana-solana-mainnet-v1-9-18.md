---
title: "[行业观察] Solana Mainnet - v1.9.18：热闹背后的规则变化"
date: 2022-04-22 10:00:00
updated: 2022-04-22 10:00:00
description: "区块链领域关键节点：Solana Mainnet - v1.9.18。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2022/blockchain-blockchain-solana-solana-mainnet-v1-9-18/
categories:
  - 资讯
tags:
  - 行业资讯
...
链上故事最怕两种声音：一种只喊“要上天”，一种只喊“要归零”。Solana Mainnet - v1.9.18 属于第三种：值得把规则读完。

Solana 在 **2022-04-22** 留下了一条可核对的公开记录：**Solana Mainnet - v1.9.18**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v1.9.18)

根据可核验公开材料，关键信息可以概括为：

- Improve metrics
- Improve cost model tracking
