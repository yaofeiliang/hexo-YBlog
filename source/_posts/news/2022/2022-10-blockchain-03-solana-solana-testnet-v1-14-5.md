---
title: "[行业观察] Solana Testnet - v1.14.5：把链上黑话翻译成人话"
date: 2022-10-04 10:00:00
updated: 2022-10-04 10:00:00
description: "区块链｜Solana Testnet - v1.14.5。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2022/blockchain-solana-solana-testnet-v1-14-5/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v1.14.5
source_published: 2022-10-04
...
Solana 在 **2022-10-04** 留下可核对记录：**Solana Testnet - v1.14.5**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 时间 | 2022-10-04 |
| 主体 | Solana |
| 事件 | Solana Testnet - v1.14.5 |
| 一手入口 | [阅读原文](https://github.com/solana-labs/solana/releases/tag/v1.14.5) |
| 收录月 | 2022-10 |
...
- **公开信息：** RPC: Support versioned txs in getFeeForMessage API (backport 28217) (28221)
...
- **公开信息：** Consensus Logging (backport 28176) (28208)
- **阅读提醒：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
- **公开信息：** Rewrite the Quick Start guide to rely exclusively on the playground (beta.solpg.io) (backport 28101) (28209)
- **阅读提醒：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
请用下面的分析骨架阅读「Solana Testnet - v1.14.5」，它比单靠情绪词汇更接近机构研报的工作方式：
...
- 原始日期：2022-10-04
- 收录月份：2022-10
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v1.14.5>
