---
title: "[行业观察] Solana Mainnet - v1.10.41：热闹背后的规则变化"
date: 2022-10-11 10:00:00
updated: 2022-10-11 10:00:00
description: "区块链领域关键节点：Solana Mainnet - v1.10.41。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2022/blockchain-blockchain-solana-solana-mainnet-v1-10-41/
categories:
  - 资讯
tags:
  - 行业资讯
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 Solana Mainnet - v1.10.41。

Solana 在 **2022-10-11** 留下了一条可核对的公开记录：**Solana Mainnet - v1.10.41**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v1.10.41)

根据可核验公开材料，关键信息可以概括为：

- count unsigned repair requests (backport 27953) (28066)
- allow unsigned repair requests (backport 27910) (28025)
- RPC: Fix ATA create instruction parsing (backport 28314) (28328)
- report additional transaction errors to metrics (backport 28285) (28294)
