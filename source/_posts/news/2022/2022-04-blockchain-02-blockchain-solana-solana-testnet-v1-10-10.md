---
title: "[行业观察] Solana Testnet - v1.10.10：热闹背后的规则变化"
date: 2022-04-26 10:00:00
updated: 2022-04-26 10:00:00
description: "区块链领域关键节点：Solana Testnet - v1.10.10。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2022/blockchain-blockchain-solana-solana-testnet-v1-10-10/
categories:
  - 资讯
tags:
  - 行业资讯
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 Solana Testnet - v1.10.10。

Solana 在 **2022-04-26** 留下了一条可核对的公开记录：**Solana Testnet - v1.10.10**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v1.10.10)
