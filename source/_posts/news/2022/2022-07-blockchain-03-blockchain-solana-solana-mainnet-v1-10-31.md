---
title: "[行业观察] Solana Mainnet - v1.10.31：热闹背后的规则变化"
date: 2022-07-12 10:00:00
updated: 2022-07-12 10:00:00
description: "区块链领域关键节点：Solana Mainnet - v1.10.31。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2022/blockchain-blockchain-solana-solana-mainnet-v1-10-31/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v1.10.31
source_published: 2022-07-12
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 Solana Mainnet - v1.10.31。

Solana 在 **2022-07-12** 留下了一条可核对的公开记录：**Solana Mainnet - v1.10.31**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2022-07-12
- **主体：** Solana
- **事件：** Solana Mainnet - v1.10.31
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v1.10.31)

根据可核验公开材料，关键信息可以概括为：

- Use client certs in QUIC to get peer's stake (backport 26477) (26567)
- Quic handshake timeout (backport 26306) (26563)
- Remove sender stakes from bankingstage buffer prioritization (backport 26512) (26562)
- preserves rentepoch for rent exempt accounts (backport 26479) (26518)
...
- 原始日期：2022-07-12
- 收录月份：2022-07
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v1.10.31>
