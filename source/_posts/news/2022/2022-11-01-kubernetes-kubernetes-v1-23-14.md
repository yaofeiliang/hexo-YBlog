---
title: "[技术观察] Kubernetes Kubernetes v1.23.14：云原生集群升级的版本信号"
...
Kubernetes 于 2022-11-10 发布「Kubernetes v1.23.14」。这类版本发布通常不只是“更新一个版本号”：它会影响 维护 Kubernetes 集群、控制平面或工作负载平台的工程团队 的依赖选择、升级节奏与验证成本。
