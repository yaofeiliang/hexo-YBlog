---
title: "[行业观察] go-ethereum Faryar (v1.10.15)：升级、托管与退出路径"
date: 2022-01-05 10:00:00
updated: 2022-01-05 10:00:00
description: "区块链｜go-ethereum Faryar (v1.10.15)。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2022/blockchain-go-ethereum-go-ethereum-faryar-v1-10-15/
categories:
  - 资讯
tags:
  - 行业资讯
...
go-ethereum Faryar (v1.10.15) 这类节点，适合当成“制度/协议变更”，而不是当成心情天气。

go-ethereum 在 **2022-01-05** 留下可核对记录：**go-ethereum Faryar (v1.10.15)**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 一手入口 | [阅读原文](https://github.com/ethereum/go-ethereum/releases/tag/v1.10.15) |
| 收录月 | 2022-01 |
...
- **公开信息：** A hang in ancient data serving caused by double-locking is fixed. (24189)
...
- **公开信息：** A crash in the LES server related to reorg handling is resolved. (24189)
- **阅读提醒：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
- **公开信息：** The SyncProgress method of ethclient.Client works again. (24199)
...
- **公开信息：** Several inconsistencies in the GraphQL API are also fixed in this release. (24190, 24188, 24191)
- **阅读提醒：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
请用下面的分析骨架阅读「go-ethereum Faryar (v1.10.15)」，它比单靠情绪词汇更接近机构研报的工作方式：
