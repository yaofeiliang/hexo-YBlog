---
title: "[行业观察] Solana Release v1.18.25：升级、托管与退出路径"
date: 2024-10-04 10:00:00
updated: 2024-10-04 10:00:00
description: "区块链｜Solana Release v1.18.25。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2024/blockchain-solana-solana-release-v1-18-25/
categories:
  - 资讯
tags:
  - 行业资讯
...
Solana 在 **2024-10-04** 留下可核对记录：**Solana Release v1.18.25**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 一手入口 | [阅读原文](https://github.com/solana-labs/solana/releases/tag/v1.18.25) |
| 收录月 | 2024-10 |
...
- **公开信息：** v1.18: extends Turbine fanout experiment to wider fanout values by @mergify in https://github.com/anza-xyz/agave/pull/2449
...
- **公开信息：** v1.18: Publish Agave docs by @mergify in https://github.com/anza-xyz/agave/pull/2921
...
- **公开信息：** v1.18: fix: set allocation size to 0 for transactions known to fail by @mergify in https://github.com/anza-xyz/agave/pull/2988
...
- **公开信息：** v1.18: ci: ignore the tonic audit as a temporary stopgap by @mergify in https://github.com/anza-xyz/agave/pull/3062
- **阅读提醒：** 把它当作待核验的工程信号：回到模块、配置键与调用链，确认是否命中你们的依赖图。
...
对「Solana Release v1.18.25」做专业诊断时，先定位它主要改写的是结构、激励，还是约束。三者抓错，后续讨论会全程错位。

请用下面的分析骨架阅读「Solana Release v1.18.25」，它比单靠情绪词汇更接近机构研报的工作方式：
