---
title: "[行业观察] Hugging Face Transformers Patch release v4.42.2：这次更新到底动了谁的奶酪"
date: 2024-06-28 10:00:00
updated: 2024-06-28 10:00:00
description: "人工智能领域关键节点：Hugging Face Transformers Patch release v4.42.2。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2024/ai-ai-hugging-face-transformers-hugging-face-transformers-patch/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/huggingface/transformers/releases/tag/v4.42.2
source_published: 2024-06-28
...
Hugging Face Transformers 在 **2024-06-28** 留下了一条可核对的公开记录：**Hugging Face Transformers Patch release v4.42.2**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **事件：** Hugging Face Transformers Patch release v4.42.2
- **一手入口：** [点这里看原文](https://github.com/huggingface/transformers/releases/tag/v4.42.2)

根据可核验公开材料，关键信息可以概括为：

- Fix Gemma2 4d attention mask (31674) by @hiyouga
- don't zero out the attentionmask when using sliding window with flash attention (31670) by @winglian
...
- 原始日期：2024-06-28
- 收录月份：2024-06
- 一手链接：<https://github.com/huggingface/transformers/releases/tag/v4.42.2>
