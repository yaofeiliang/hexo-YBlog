---
title: "[行业观察] Solana Release v1.18.23：把链上黑话翻译成人话"
date: 2024-08-31 10:00:00
updated: 2024-08-31 10:00:00
description: "区块链｜Solana Release v1.18.23。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2024/blockchain-solana-solana-release-v1-18-23/
categories:
  - 资讯
tags:
  - 行业资讯
...
Solana 在 **2024-08-31** 留下可核对记录：**Solana Release v1.18.23**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 一手入口 | [阅读原文](https://github.com/solana-labs/solana/releases/tag/v1.18.23) |
| 收录月 | 2024-08 |
...
- **公开信息：** v1.18: blockstore: only consume duplicate proofs from rootslot + 1 on startup
...
- **公开信息：** v1.18: RPC: rewards, return error if epochboundaryblock is a lie
- **阅读提醒：** 把它当作待核验的工程信号：回到模块、配置键与调用链，确认是否命中你们的依赖图。
...
- **公开信息：** v1.18: fix: send votes to the immediate next leader
...
- **公开信息：** v1.18: replay: do not early return when marking slots duplicate confirmed
- **阅读提醒：** 把它当作待核验的工程信号：回到模块、配置键与调用链，确认是否命中你们的依赖图。
...
- **公开信息：** v1.18: rpc: add more services to getClusterNodes
...
对「Solana Release v1.18.23」做专业诊断时，先定位它主要改写的是结构、激励，还是约束。三者抓错，后续讨论会全程错位。

请用下面的分析骨架阅读「Solana Release v1.18.23」，它比单靠情绪词汇更接近机构研报的工作方式：
