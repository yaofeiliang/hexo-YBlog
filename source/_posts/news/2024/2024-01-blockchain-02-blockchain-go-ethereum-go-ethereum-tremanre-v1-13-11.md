---
title: "[行业观察] go-ethereum Tremanre (v1.13.11)：热闹背后的规则变化"
date: 2024-01-24 10:00:00
updated: 2024-01-24 10:00:00
description: "区块链领域关键节点：go-ethereum Tremanre (v1.13.11)。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2024/blockchain-blockchain-go-ethereum-go-ethereum-tremanre-v1-13-11/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/ethereum/go-ethereum/releases/tag/v1.13.11
source_published: 2024-01-24
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 go-ethereum Tremanre (v1.13.11)。

go-ethereum 在 **2024-01-24** 留下了一条可核对的公开记录：**go-ethereum Tremanre (v1.13.11)**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2024-01-24
- **主体：** go-ethereum
- **事件：** go-ethereum Tremanre (v1.13.11)
- **一手入口：** [点这里看原文](https://github.com/ethereum/go-ethereum/releases/tag/v1.13.11)
...
- Change how transaction indexing operates. As of 1.13.11, the behaviour of ethsyncing is slightly changed, so that it now
...
- 原始日期：2024-01-24
- 收录月份：2024-01
- 一手链接：<https://github.com/ethereum/go-ethereum/releases/tag/v1.13.11>
