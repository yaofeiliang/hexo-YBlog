---
title: "[行业观察] Solana Testnet - v1.18.9：比行情截图更值得读的部分"
date: 2024-03-29 10:00:00
updated: 2024-03-29 10:00:00
description: "区块链｜Solana Testnet - v1.18.9。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2024/blockchain-solana-solana-testnet-v1-18-9/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v1.18.9
source_published: 2024-03-29
...
Solana 在 **2024-03-29** 留下可核对记录：**Solana Testnet - v1.18.9**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 时间 | 2024-03-29 |
| 主体 | Solana |
| 事件 | Solana Testnet - v1.18.9 |
| 一手入口 | [阅读原文](https://github.com/solana-labs/solana/releases/tag/v1.18.9) |
| 收录月 | 2024-03 |
...
- **公开信息：** v1.18: ci: add release pipeline (backport of 466) (487)
...
- **公开信息：** v1.18: shred: expose chained merkle root (backport of 435) (459)
- **阅读提醒：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
- **公开信息：** v1.18: implements weighted shuffle using N-ary tree (backport of 259) (429)
- **阅读提醒：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
- **公开信息：** v1.18: implements weighted shuffle using binary tree (backport of 185) (425)
- **阅读提醒：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
请用下面的分析骨架阅读「Solana Testnet - v1.18.9」，它比单靠情绪词汇更接近机构研报的工作方式：
...
- 原始日期：2024-03-29
- 收录月份：2024-03
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v1.18.9>
