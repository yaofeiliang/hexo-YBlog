---
title: "[行业观察] Solana Release v1.18.23：热闹背后的规则变化"
date: 2024-08-31 10:00:00
updated: 2024-08-31 10:00:00
description: "区块链领域关键节点：Solana Release v1.18.23。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2024/blockchain-blockchain-solana-solana-release-v1-18-23/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v1.18.23
source_published: 2024-08-31
...
Solana 在 **2024-08-31** 留下了一条可核对的公开记录：**Solana Release v1.18.23**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2024-08-31
- **主体：** Solana
- **事件：** Solana Release v1.18.23
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v1.18.23)

根据可核验公开材料，关键信息可以概括为：

- v1.18: blockstore: only consume duplicate proofs from rootslot + 1 on startup
- v1.18: RPC: rewards, return error if epochboundaryblock is a lie
...
- 原始日期：2024-08-31
- 收录月份：2024-08
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v1.18.23>
