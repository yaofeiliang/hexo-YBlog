---
title: "[行业观察] go-ethereum Tremanre (v1.13.11)：升级、托管与退出路径"
date: 2024-01-24 10:00:00
updated: 2024-01-24 10:00:00
description: "区块链｜go-ethereum Tremanre (v1.13.11)。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2024/blockchain-go-ethereum-go-ethereum-tremanre-v1-13-11/
categories:
  - 资讯
tags:
  - 行业资讯
...
go-ethereum Tremanre (v1.13.11) 这类节点，适合当成“制度/协议变更”，而不是当成心情天气。

go-ethereum 在 **2024-01-24** 留下可核对记录：**go-ethereum Tremanre (v1.13.11)**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 一手入口 | [阅读原文](https://github.com/ethereum/go-ethereum/releases/tag/v1.13.11) |
| 收录月 | 2024-01 |
...
- **公开信息：** Enable Cancun on Sepolia and Holesky, plus Cancun-related changes (28834, 28246, 28230, 28827)
...
- **公开信息：** Support EIP-4844 transactions in API-methods (28786)
- **阅读提醒：** 能力扩展信号：先判断它解决的是产品瓶颈、工程效率还是可观测性，再排优先级。
...
- **公开信息：** Change how transaction indexing operates. As of 1.13.11, the behaviour of ethsyncing is slightly changed, so that it now
...
- **公开信息：** rlpdump: add -pos flag for displaying byte positions (28785)
- **阅读提醒：** 能力扩展信号：先判断它解决的是产品瓶颈、工程效率还是可观测性，再排优先级。
...
- **公开信息：** Fixes logging configuration (28801)
...
请用下面的分析骨架阅读「go-ethereum Tremanre (v1.13.11)」，它比单靠情绪词汇更接近机构研报的工作方式：
