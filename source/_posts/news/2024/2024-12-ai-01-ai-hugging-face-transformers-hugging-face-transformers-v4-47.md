---
title: "[行业观察] Hugging Face Transformers v4.47.1：这次更新到底动了谁的奶酪"
date: 2024-12-17 10:00:00
updated: 2024-12-17 10:00:00
description: "人工智能领域关键节点：Hugging Face Transformers v4.47.1。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
...
source_url: https://github.com/huggingface/transformers/releases/tag/v4.47.1
source_published: 2024-12-17
...
如果说 AI 是一场连续剧，那么「Hugging Face Transformers v4.47.1」就是那集人人都在刷弹幕的高潮。

Hugging Face Transformers 在 **2024-12-17** 留下了一条可核对的公开记录：**Hugging Face Transformers v4.47.1**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **事件：** Hugging Face Transformers v4.47.1
- **一手入口：** [点这里看原文](https://github.com/huggingface/transformers/releases/tag/v4.47.1)

根据可核验公开材料，关键信息可以概括为：

- Fix GA loss bugs and add unit test (35121)
- Fix numitemsinbatch not being an integer (35115))
- Fix FSDP no longer working (35212)
- Don't use nosync when DeepSpeed doesn't support it for certain ZeRO configurations (35212)
...
- 原始日期：2024-12-17
- 收录月份：2024-12
- 一手链接：<https://github.com/huggingface/transformers/releases/tag/v4.47.1>
