---
title: "[行业观察] Reth Reth v1.1.2：热闹背后的规则变化"
date: 2024-11-19 10:00:00
updated: 2024-11-19 10:00:00
description: "区块链领域关键节点：Reth Reth v1.1.2。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2024/blockchain-blockchain-reth-reth-reth-v1-1-2/
categories:
  - 资讯
tags:
  - 行业资讯
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 Reth Reth v1.1.2。

Reth 在 **2024-11-19** 留下了一条可核对的公开记录：**Reth Reth v1.1.2**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **主体：** Reth
- **事件：** Reth Reth v1.1.2
- **一手入口：** [点这里看原文](https://github.com/paradigmxyz/reth/releases/tag/v1.1.2)

根据可核验公开材料，关键信息可以概括为：

- feat(payload) : optimize new payload job by fetching only header hash instead of block (12343)
- feat: mevsimBundle (12218)
- fix: pending transaction ordering (12382)
- fix: consume all payload variants (https://github.com/paradigmxyz/reth/pull/12520)
