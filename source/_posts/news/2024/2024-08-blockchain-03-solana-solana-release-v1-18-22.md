---
title: "[行业观察] Solana Release v1.18.22：比行情截图更值得读的部分"
date: 2024-08-09 10:00:00
updated: 2024-08-09 10:00:00
description: "区块链｜Solana Release v1.18.22。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2024/blockchain-solana-solana-release-v1-18-22/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v1.18.22
source_published: 2024-08-09
...
Solana 在 **2024-08-09** 留下可核对记录：**Solana Release v1.18.22**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 时间 | 2024-08-09 |
| 主体 | Solana |
| 事件 | Solana Release v1.18.22 |
| 一手入口 | [阅读原文](https://github.com/solana-labs/solana/releases/tag/v1.18.22) |
| 收录月 | 2024-08 |
...
- **公开信息：** Bump rbpf version to 0.8.3 (backport of 2515) in https://github.com/anza-xyz/agave/pull/2513
...
- **公开信息：** Solana 通过公开页面发布了与「Solana Release v1.18.22」相关的信息，供市场与开发者核对。
...
请用下面的分析骨架阅读「Solana Release v1.18.22」，它比单靠情绪词汇更接近机构研报的工作方式：
...
- 原始日期：2024-08-09
- 收录月份：2024-08
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v1.18.22>
