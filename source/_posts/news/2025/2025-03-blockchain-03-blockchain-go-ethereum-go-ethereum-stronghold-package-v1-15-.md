---
title: "[行业观察] go-ethereum Stronghold Package (v1.15.5)：热闹背后的规则变化"
date: 2025-03-05 10:00:00
updated: 2025-03-05 10:00:00
description: "区块链领域关键节点：go-ethereum Stronghold Package (v1.15.5)。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2025/blockchain-blockchain-go-ethereum-go-ethereum-stronghold-package-v1-15-/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/ethereum/go-ethereum/releases/tag/v1.15.5
source_published: 2025-03-05
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 go-ethereum Stronghold Package (v1.15.5)。

go-ethereum 在 **2025-03-05** 留下了一条可核对的公开记录：**go-ethereum Stronghold Package (v1.15.5)**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2025-03-05
- **主体：** go-ethereum
- **事件：** go-ethereum Stronghold Package (v1.15.5)
- **一手入口：** [点这里看原文](https://github.com/ethereum/go-ethereum/releases/tag/v1.15.5)

根据可核验公开材料，关键信息可以概括为：

- In output of debugtraceTransaction, the "memory" and "storage" fields will be omitted if empty. (31289)
...
- 原始日期：2025-03-05
- 收录月份：2025-03
- 一手链接：<https://github.com/ethereum/go-ethereum/releases/tag/v1.15.5>
