---
title: "[行业观察] go-ethereum Leather Wrapping (v1.16.6)：热闹背后的规则变化"
date: 2025-11-03 10:00:00
updated: 2025-11-03 10:00:00
description: "区块链领域关键节点：go-ethereum Leather Wrapping (v1.16.6)。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2025/blockchain-blockchain-go-ethereum-go-ethereum-leather-wrapping-v1-16-6/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/ethereum/go-ethereum/releases/tag/v1.16.6
source_published: 2025-11-03
...
go-ethereum 在 **2025-11-03** 留下了一条可核对的公开记录：**go-ethereum Leather Wrapping (v1.16.6)**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2025-11-03
- **主体：** go-ethereum
- **事件：** go-ethereum Leather Wrapping (v1.16.6)
- **一手入口：** [点这里看原文](https://github.com/ethereum/go-ethereum/releases/tag/v1.16.6)

根据可核验公开材料，关键信息可以概括为：

- Set mainnet timestamps for Osaka (33063)
- Enable Fusaka for geth --dev mode (32917)
- Add ethsendRawTransactionSync which waits until either a timeout or the transaction is mined. This feature is mostly useful on L2s with lower blocktimes. (32830, 32930, 32929)
- Add support for ethsimulateV1 in ethclient (32856)
...
- 原始日期：2025-11-03
- 收录月份：2025-11
- 一手链接：<https://github.com/ethereum/go-ethereum/releases/tag/v1.16.6>
