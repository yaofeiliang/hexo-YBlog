---
title: "[行业观察] go-ethereum Coolant Cells (v1.16.5)：热闹背后的规则变化"
date: 2025-10-16 10:00:00
updated: 2025-10-16 10:00:00
description: "区块链领域关键节点：go-ethereum Coolant Cells (v1.16.5)。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2025/blockchain-blockchain-go-ethereum-go-ethereum-coolant-cells-v1-16-5/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/ethereum/go-ethereum/releases/tag/v1.16.5
source_published: 2025-10-16
...
go-ethereum 在 **2025-10-16** 留下了一条可核对的公开记录：**go-ethereum Coolant Cells (v1.16.5)**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2025-10-16
- **主体：** go-ethereum
- **事件：** go-ethereum Coolant Cells (v1.16.5)
- **一手入口：** [点这里看原文](https://github.com/ethereum/go-ethereum/releases/tag/v1.16.5)

根据可核验公开材料，关键信息可以概括为：

- ethsendRawTransaction has an upgrade path for blob proofs after the Fusaka fork. Note this is temporary. We will remove support for blob proof conversion during the v1.17.x release cycle, please update RPC client libraries to support cell-level (v1) proofs. (32849)
- ethsubscribe now supports a transactionReceipts subscription. There is also a wrapper in ethclient for this new subscription type. (32697, 32869)
- ethsimulateV1 was fixed to return the block timestamp in logs, like ethgetLogs does. (32831)
...
- 原始日期：2025-10-16
- 收录月份：2025-10
- 一手链接：<https://github.com/ethereum/go-ethereum/releases/tag/v1.16.5>
