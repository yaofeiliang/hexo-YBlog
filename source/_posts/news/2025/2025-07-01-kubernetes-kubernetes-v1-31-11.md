...
description: "Kubernetes 于 2025-07-15 发布 Kubernetes v1.31.11。结合官方条目、场景推演与升级检查，帮你判断要不要跟、怎么跟。"
...
Kubernetes 在 2025-07-15 放出了 Kubernetes v1.31.11。我建议你别急着点升级：先花两分钟搞清楚“它动到了哪一层”。
...
一手入口在这里：<https://github.com/kubernetes/kubernetes/releases/tag/v1.31.11>
...
| --- | --- |
| 工具 / 项目 | Kubernetes |
| 发布名称 | Kubernetes v1.31.11 |
| 版本标签 | v1.31.11 |
| 原始发布日期 | 2025-07-15 |
| 是否预发布 | 否（正式发布版本） |
| 仓库 | kubernetes/kubernetes |
| 官方发布页 | [查看原文](https://github.com/kubernetes/kubernetes/releases/tag/v1.31.11) |
...
对 Kubernetes（Kubernetes v1.31.11 / v1.31.11），建议按下列层面对齐阅读，而不是只扫版本号：
