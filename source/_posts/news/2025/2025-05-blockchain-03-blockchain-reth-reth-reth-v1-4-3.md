---
title: "[行业观察] Reth Reth v1.4.3：热闹背后的规则变化"
date: 2025-05-20 10:00:00
updated: 2025-05-20 10:00:00
description: "区块链领域关键节点：Reth Reth v1.4.3。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2025/blockchain-blockchain-reth-reth-reth-v1-4-3/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/paradigmxyz/reth/releases/tag/v1.4.3
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 Reth Reth v1.4.3。

Reth 在 **2025-05-20** 留下了一条可核对的公开记录：**Reth Reth v1.4.3**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **主体：** Reth
- **事件：** Reth Reth v1.4.3
- **一手入口：** [点这里看原文](https://github.com/paradigmxyz/reth/releases/tag/v1.4.3)

根据可核验公开材料，关键信息可以概括为：

- 7702 Authorizations no longer fail to deserialize if both v and yParity fields are provided: https://github.com/alloy-rs/eips/pull/38
...
- ci: do not dry run by default in release.yml by @shekhirin in https://github.com/paradigmxyz/reth/pull/16358
- chore: Add configuration option to enable/disable HTTP response compression by @ByteYue in https://github.com/paradigmxyz/reth/pull/16348

如果你只看社交网络摘要，通常会漏掉限制条件、适用对象和“下一步时间表”。原文里这些边角，才是真正影响执行的地方。

## 为什么这件事值得盯

Reth 的版本节奏会影响依赖升级、安全补丁与工程排期；把它当作基础设施信号而不是营销海报。
...
- 原始日期：2025-05-20
- 收录月份：2025-05
- 一手链接：<https://github.com/paradigmxyz/reth/releases/tag/v1.4.3>
