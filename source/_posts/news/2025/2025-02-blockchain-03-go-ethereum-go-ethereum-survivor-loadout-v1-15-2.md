---
title: "[行业观察] go-ethereum Survivor Loadout (v1.15.2)：比行情截图更值得读的部分"
date: 2025-02-17 10:00:00
updated: 2025-02-17 10:00:00
description: "区块链｜go-ethereum Survivor Loadout (v1.15.2)。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2025/blockchain-go-ethereum-go-ethereum-survivor-loadout-v1-15-2/
categories:
  - 资讯
tags:
  - 行业资讯
...
go-ethereum 在 **2025-02-17** 留下可核对记录：**go-ethereum Survivor Loadout (v1.15.2)**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 一手入口 | [阅读原文](https://github.com/ethereum/go-ethereum/releases/tag/v1.15.2) |
| 收录月 | 2025-02 |
...
- **公开信息：** Block building on mainnet works again. (31191)
...
- **公开信息：** Discv5 and DNS peer discovery has been restored. It was accidentally disabled in v1.14.9. (31185)
- **阅读提醒：** 把它当作待核验的工程信号：回到模块、配置键与调用链，确认是否命中你们的依赖图。
...
- **公开信息：** An edge-case for geth dumpconfig related to the P2P.NAT setting in TOML is fixed. (31192)
...
请用下面的分析骨架阅读「go-ethereum Survivor Loadout (v1.15.2)」，它比单靠情绪词汇更接近机构研报的工作方式：
