---
title: "[行业观察] OpenZeppelin Contracts OpenZeppelin Contracts 3.0 beta：热闹背后的规则变化"
date: 2020-02-15 10:00:00
updated: 2020-02-15 10:00:00
description: "区块链领域关键节点：OpenZeppelin Contracts OpenZeppelin Contracts 3.0 beta。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2020/blockchain-blockchain-openzeppelin-contracts-openzeppelin-contracts-ope/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/OpenZeppelin/openzeppelin-contracts/releases/tag/v3.0.0-beta.0
source_published: 2020-02-15
...
链上故事最怕两种声音：一种只喊“要上天”，一种只喊“要归零”。OpenZeppelin Contracts OpenZeppelin Contracts 3.0 beta 属于第三种：值得把规则读完。

OpenZeppelin Contracts 在 **2020-02-15** 留下了一条可核对的公开记录：**OpenZeppelin Contracts OpenZeppelin Contracts 3.0 beta**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **事件：** OpenZeppelin Contracts OpenZeppelin Contracts 3.0 beta
- **一手入口：** [点这里看原文](https://github.com/OpenZeppelin/openzeppelin-contracts/releases/tag/v3.0.0-beta.0)
...
- 原始日期：2020-02-15
- 收录月份：2020-02
- 一手链接：<https://github.com/OpenZeppelin/openzeppelin-contracts/releases/tag/v3.0.0-beta.0>
