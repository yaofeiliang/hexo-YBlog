---
title: "[技术观察] TypeScript TypeScript 3.6.5：给忙碌开发者的人话导读"
date: 2020-01-23 09:00:00
updated: 2020-01-23 09:00:00
description: "TypeScript 于 2020-01-23 发布 TypeScript 3.6.5。结合官方条目、场景推演与升级检查，帮你判断要不要跟、怎么跟。"
...
如果你的项目还在用 TypeScript，2020-01-23 这则 TypeScript 3.6.5 至少该进待办，不该只进收藏夹。
...
一手入口在这里：<https://github.com/microsoft/TypeScript/releases/tag/v3.6.5>
...
| --- | --- |
| 工具 / 项目 | TypeScript |
| 发布名称 | TypeScript 3.6.5 |
| 版本标签 | v3.6.5 |
| 原始发布日期 | 2020-01-23 |
| 是否预发布 | 否（正式发布版本） |
| 仓库 | microsoft/TypeScript |
| 官方发布页 | [查看原文](https://github.com/microsoft/TypeScript/releases/tag/v3.6.5) |
...
- **官方原文：** fixed issues query for Typescript v3.6.5.
  - **怎么读：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
- **官方原文：** fixed issues query for Typescript v3.6.4.
  - **怎么读：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
- **官方原文：** fixed issues query for Typescript v3.6.3.
  - **怎么读：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
对 TypeScript（TypeScript 3.6.5 / v3.6.5），建议按下列层面对齐阅读，而不是只扫版本号：
...
二阶效应上，版本标签（v3.6.5）只是索引；真正决定组织反应速度的，是你们有没有可复用的回归资产与明确的“不升级”条件。
