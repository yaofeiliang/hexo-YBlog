---
title: "[技术观察] TypeScript TypeScript 3.6.5：类型系统升级前的兼容性提示"
...
source_url: https://github.com/microsoft/TypeScript/releases/tag/v3.6.5
...
TypeScript 于 2020-01-23 发布「TypeScript 3.6.5」。这类版本发布通常不只是“更新一个版本号”：它会影响 维护 TypeScript 应用、库或声明文件的开发者 的依赖选择、升级节奏与验证成本。
...
This patch fixes when encountering a private get accessor in a .d.ts file. This is an issue when using packages published from TypeScript 3.7 and newer. Users can upgrade to 3.6.5 to fix the issue. For release notes, check out the . For the complete list of fixed issues, check out the . . . . . . Downloads are available on: ( )
...
- 原始发布日期：2020-01-23
- 收录月份：2020-01
- 发布页：<https://github.com/microsoft/TypeScript/releases/tag/v3.6.5>

## 来源与声明

- 本文是对官方发布记录的后期整理，不代表姚飞亮在 2020-01 已在本站发表本文。
