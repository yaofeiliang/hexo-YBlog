---
title: "[行业观察] Hugging Face Transformers Rust Tokenizers, DistilBERT base cased, Model cards：这次更新到底动了谁的奶酪"
date: 2020-02-19 10:00:00
updated: 2020-02-19 10:00:00
description: "人工智能领域关键节点：Hugging Face Transformers Rust Tokenizers, DistilBERT base cased, Model cards。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2020/ai-ai-hugging-face-transformers-hugging-face-transformers-rust-/
categories:
  - 资讯
tags:
  - 行业资讯
...
ai_generated: false
source_count: 1
historical_period: 2020-02
source_url: https://github.com/huggingface/transformers/releases/tag/v2.5.0
source_published: 2020-02-19
...
Hugging Face Transformers 在 **2020-02-19** 留下了一条可核对的公开记录：**Hugging Face Transformers Rust Tokenizers, DistilBERT base cased, Model cards**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **事件：** Hugging Face Transformers Rust Tokenizers, DistilBERT base cased, Model cards
- **一手入口：** [点这里看原文](https://github.com/huggingface/transformers/releases/tag/v2.5.0)
...
- Calling batchencodeplus on fast version of tokenizers will make better usage of CPU-cores.
- Tokenizers leveraging native implementation will use all the CPU-cores by default when calling batchencodeplus. You can change this behavior by setting the environment variable RAYONNUMTHREADS = N
...
- 原始日期：2020-02-19
- 收录月份：2020-02
- 一手链接：<https://github.com/huggingface/transformers/releases/tag/v2.5.0>

## 来源与声明

- 本文是对官方公开信息的后期整理，不代表姚飞亮在 2020-02 已在本站发表本文。
