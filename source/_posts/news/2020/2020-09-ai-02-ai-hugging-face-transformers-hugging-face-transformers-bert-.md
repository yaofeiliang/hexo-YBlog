---
title: "[行业观察] Hugging Face Transformers Bert Seq2Seq models, FSMT, LayoutLM, Funnel Transformer, LXMERT：这次更新到底动了谁的奶酪"
date: 2020-09-22 10:00:00
updated: 2020-09-22 10:00:00
description: "人工智能领域关键节点：Hugging Face Transformers Bert Seq2Seq models, FSMT, LayoutLM, Funnel Transformer, LXMERT。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2020/ai-ai-hugging-face-transformers-hugging-face-transformers-bert-/
categories:
  - 资讯
tags:
  - 行业资讯
...
ai_generated: false
source_count: 1
historical_period: 2020-09
source_url: https://github.com/huggingface/transformers/releases/tag/v3.2.0
source_published: 2020-09-22
...
Hugging Face Transformers 在 **2020-09-22** 留下了一条可核对的公开记录：**Hugging Face Transformers Bert Seq2Seq models, FSMT, LayoutLM, Funnel Transformer, LXMERT**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **事件：** Hugging Face Transformers Bert Seq2Seq models, FSMT, LayoutLM, Funnel Transformer, LXMERT
- **一手入口：** [点这里看原文](https://github.com/huggingface/transformers/releases/tag/v3.2.0)

根据可核验公开材料，关键信息可以概括为：

- google/roberta2robertaL-24bbc
- google/roberta2robertaL-24gigaword
- google/roberta2robertaL-24cnndailymail
- google/roberta2robertaL-24discofuse
...
- 原始日期：2020-09-22
- 收录月份：2020-09
- 一手链接：<https://github.com/huggingface/transformers/releases/tag/v3.2.0>
