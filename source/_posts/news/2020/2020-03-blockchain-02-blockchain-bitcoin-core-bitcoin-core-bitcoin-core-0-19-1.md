---
title: "[行业观察] Bitcoin Core Bitcoin Core 0.19.1：热闹背后的规则变化"
date: 2020-03-09 10:00:00
updated: 2020-03-09 10:00:00
description: "区块链领域关键节点：Bitcoin Core Bitcoin Core 0.19.1。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2020/blockchain-blockchain-bitcoin-core-bitcoin-core-bitcoin-core-0-19-1/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/bitcoin/bitcoin/releases/tag/v0.19.1
source_published: 2020-03-09
...
Bitcoin Core 在 **2020-03-09** 留下了一条可核对的公开记录：**Bitcoin Core Bitcoin Core 0.19.1**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2020-03-09
- **主体：** Bitcoin Core
- **事件：** Bitcoin Core Bitcoin Core 0.19.1
- **一手入口：** [点这里看原文](https://github.com/bitcoin/bitcoin/releases/tag/v0.19.1)

根据可核验公开材料，关键信息可以概括为：

- Bitcoin Core version 0.19.1 is now available from: https://bitcoincore.org/bin/bitcoin-core-0.19.1/ For the release notes please see the git repository: https://github.com/bitcoin/bitcoin/blob/master/doc/release-notes/release-notes-0.19.1.md Preferably use the above download link, not the links provided by GitHub to download the source tarball, as the release tarballs are generated deterministically whereas GitHub's are not.
...
- 原始日期：2020-03-09
- 收录月份：2020-03
- 一手链接：<https://github.com/bitcoin/bitcoin/releases/tag/v0.19.1>
