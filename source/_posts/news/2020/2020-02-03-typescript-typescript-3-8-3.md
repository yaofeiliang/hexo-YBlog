---
title: "[技术观察] TypeScript TypeScript 3.8.3：把发布说明读成可执行的检查单"
date: 2020-02-28 09:00:00
updated: 2020-02-28 09:00:00
description: "TypeScript 于 2020-02-28 发布 TypeScript 3.8.3。结合官方条目、场景推演与升级检查，帮你判断要不要跟、怎么跟。"
...
又一条值得记账的发布：TypeScript TypeScript 3.8.3（2020-02-28）。标题可以热闹，决策还是得冷静。
...
一手入口在这里：<https://github.com/microsoft/TypeScript/releases/tag/v3.8.3>
...
| --- | --- |
| 工具 / 项目 | TypeScript |
| 发布名称 | TypeScript 3.8.3 |
| 版本标签 | v3.8.3 |
| 原始发布日期 | 2020-02-28 |
| 是否预发布 | 否（正式发布版本） |
| 仓库 | microsoft/TypeScript |
| 官方发布页 | [查看原文](https://github.com/microsoft/TypeScript/releases/tag/v3.8.3) |
...
- **官方原文：** fixed issues query for Typescript v3.8.0 (Beta).
  - **怎么读：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
- **官方原文：** fixed issues query for Typescript v3.8.1 (RC).
  - **怎么读：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
- **官方原文：** fixed issues query for Typescript v3.8.2 (Final).
  - **怎么读：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
- **官方原文：** fixed issues query for Typescript v3.8.3.
  - **怎么读：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
对 TypeScript（TypeScript 3.8.3 / v3.8.3），建议按下列层面对齐阅读，而不是只扫版本号：
