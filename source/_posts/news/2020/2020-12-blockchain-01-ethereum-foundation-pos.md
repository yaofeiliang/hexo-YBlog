---
title: "[行业观察] 以太坊完成信标链上线（PoS 序章）：比行情截图更值得读的部分"
date: 2020-12-01 10:00:00
updated: 2020-12-01 10:00:00
description: "区块链｜以太坊完成信标链上线（PoS 序章）。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2020/blockchain-ethereum-foundation-pos/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://blog.ethereum.org/2020/12/01/eth2-quick-update-no-21
source_published: 2020-12-01
...
Ethereum Foundation 在 **2020-12-01** 留下可核对记录：**以太坊完成信标链上线（PoS 序章）**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 事件 | 以太坊完成信标链上线（PoS 序章） |
| 一手入口 | [阅读原文](https://blog.ethereum.org/2020/12/01/eth2-quick-update-no-21) |
| 收录月 | 2020-12 |
...
请用下面的分析骨架阅读「以太坊完成信标链上线（PoS 序章）」，它比单靠情绪词汇更接近机构研报的工作方式：
...
- 原始日期：2020-12-01
- 收录月份：2020-12
- 一手链接：<https://blog.ethereum.org/2020/12/01/eth2-quick-update-no-21>
