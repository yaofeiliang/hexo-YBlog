---
title: "[行业观察] Solana Slow is Smooth, Smooth is Fast：热闹背后的规则变化"
date: 2020-01-28 10:00:00
updated: 2020-01-28 10:00:00
description: "区块链领域关键节点：Solana Slow is Smooth, Smooth is Fast。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2020/blockchain-blockchain-solana-solana-slow-is-smooth-smooth-is-fast/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v0.23.0
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 Solana Slow is Smooth, Smooth is Fast。

Solana 在 **2020-01-28** 留下了一条可核对的公开记录：**Solana Slow is Smooth, Smooth is Fast**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2020-01-28
- **主体：** Solana
- **事件：** Solana Slow is Smooth, Smooth is Fast
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v0.23.0)

根据可核验公开材料，关键信息可以概括为：

- Simplified voting and staking rewards redemption
- Solana command-line improvements:
- New stakes subcommand to view all cluster stakes
- New create-address-with-seed to generate derived account addresses
...
- 原始日期：2020-01-28
- 收录月份：2020-01
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v0.23.0>
