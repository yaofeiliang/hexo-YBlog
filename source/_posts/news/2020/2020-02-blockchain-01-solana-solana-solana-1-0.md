---
title: "[行业观察] Solana Solana 1.0：先看规则，再看热闹"
date: 2020-02-25 10:00:00
updated: 2020-02-25 10:00:00
description: "区块链｜Solana Solana 1.0。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2020/blockchain-solana-solana-solana-1-0/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v1.0.0
source_published: 2020-02-25
...
Solana 在 **2020-02-25** 留下可核对记录：**Solana Solana 1.0**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 时间 | 2020-02-25 |
| 主体 | Solana |
| 事件 | Solana Solana 1.0 |
| 一手入口 | [阅读原文](https://github.com/solana-labs/solana/releases/tag/v1.0.0) |
| 收录月 | 2020-02 |
...
- **公开信息：** Smart contracts platform marked stable and en route to mainnet
...
- **公开信息：** Added support for Ledger Wallet to the command-line interface
...
请用下面的分析骨架阅读「Solana Solana 1.0」，它比单靠情绪词汇更接近机构研报的工作方式：
...
- 原始日期：2020-02-25
- 收录月份：2020-02
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v1.0.0>
