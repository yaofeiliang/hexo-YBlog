---
title: "[行业观察] Solana v1.2.0：升级、托管与退出路径"
date: 2020-05-27 10:00:00
updated: 2020-05-27 10:00:00
description: "区块链｜Solana v1.2.0。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2020/blockchain-solana-solana-v1-2-0/
categories:
  - 资讯
tags:
  - 行业资讯
...
Solana v1.2.0 这类节点，适合当成“制度/协议变更”，而不是当成心情天气。

Solana 在 **2020-05-27** 留下可核对记录：**Solana v1.2.0**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 主体 | Solana |
| 事件 | Solana v1.2.0 |
| 一手入口 | [阅读原文](https://github.com/solana-labs/solana/releases/tag/v1.2.0) |
| 收录月 | 2020-05 |
...
- **公开信息：** Add support for cross-program invocations that allow on-chain programs to issue synchronous processed instructions to other programs.
...
- **公开信息：** Add support for program signing with program derived addresses
- **阅读提醒：** 能力扩展信号：先判断它解决的是产品瓶颈、工程效率还是可观测性，再排优先级。
...
- **公开信息：** Average TPS has regressed from the v1.0.0 release
...
请用下面的分析骨架阅读「Solana v1.2.0」，它比单靠情绪词汇更接近机构研报的工作方式：
