---
title: "[行业观察] OpenZeppelin Contracts OpenZeppelin Contracts 3.0 beta：升级、托管与退出路径"
date: 2020-02-15 10:00:00
updated: 2020-02-15 10:00:00
description: "区块链｜OpenZeppelin Contracts OpenZeppelin Contracts 3.0 beta。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
...
OpenZeppelin Contracts 在 **2020-02-15** 留下可核对记录：**OpenZeppelin Contracts OpenZeppelin Contracts 3.0 beta**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 一手入口 | [阅读原文](https://github.com/OpenZeppelin/openzeppelin-contracts/releases/tag/v3.0.0-beta.0) |
| 收录月 | 2020-02 |
...
- **公开信息：** All contracts were migrated to ^0.6.0.
...
- **公开信息：** Roles contracts (such as MinterRole and PauserRole) were removed: we're redesigning our Access Control solution and will have a better version of these in the v3.0 release.
...
- **公开信息：** We've added hooks, a new feature of the library that will make extending it easier than ever. Read more below!
...
请用下面的分析骨架阅读「OpenZeppelin Contracts OpenZeppelin Contracts 3.0 beta」，它比单靠情绪词汇更接近机构研报的工作方式：
