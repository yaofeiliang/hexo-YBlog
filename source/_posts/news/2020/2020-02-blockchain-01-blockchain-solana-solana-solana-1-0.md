---
title: "[行业观察] Solana Solana 1.0：热闹背后的规则变化"
date: 2020-02-25 10:00:00
updated: 2020-02-25 10:00:00
description: "区块链领域关键节点：Solana Solana 1.0。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2020/blockchain-blockchain-solana-solana-solana-1-0/
categories:
  - 资讯
tags:
  - 行业资讯
...
Solana 在 **2020-02-25** 留下了一条可核对的公开记录：**Solana Solana 1.0**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v1.0.0)

根据可核验公开材料，关键信息可以概括为：

- Smart contracts platform marked stable and en route to mainnet
- Added support for Ledger Wallet to the command-line interface
- Moar TPS!
