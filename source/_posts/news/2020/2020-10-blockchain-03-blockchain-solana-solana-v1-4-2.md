---
title: "[行业观察] Solana v1.4.2：热闹背后的规则变化"
date: 2020-10-23 10:00:00
updated: 2020-10-23 10:00:00
description: "区块链领域关键节点：Solana v1.4.2。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2020/blockchain-blockchain-solana-solana-v1-4-2/
categories:
  - 资讯
tags:
  - 行业资讯
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 Solana v1.4.2。

Solana 在 **2020-10-23** 留下了一条可核对的公开记录：**Solana v1.4.2**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **主体：** Solana
- **事件：** Solana v1.4.2
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v1.4.2)

根据可核验公开材料，关键信息可以概括为：

- Validators can now specify their advertised RPC address
- Various gossip optimizations
- Improves CLI compatibility with older clusters (below 1.3.16)
- Failed CLI program deployments can now be retried
