...
permalink: news/2020/ai-ai-pytorch-pytorch-bug-fix-release/
categories:
  - 资讯
tags:
  - 行业资讯
...
PyTorch 在 **2020-06-18** 留下了一条可核对的公开记录：**PyTorch Bug Fix release**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **一手入口：** [点这里看原文](https://github.com/pytorch/pytorch/releases/tag/v1.5.1)
