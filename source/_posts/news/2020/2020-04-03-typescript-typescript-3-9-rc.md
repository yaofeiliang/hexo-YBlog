---
title: "[技术观察] TypeScript TypeScript 3.9 RC：给忙碌开发者的人话导读"
date: 2020-04-28 09:00:00
updated: 2020-04-28 09:00:00
description: "TypeScript 于 2020-04-28 发布 TypeScript 3.9 RC。结合官方条目、场景推演与升级检查，帮你判断要不要跟、怎么跟。"
...
又一条值得记账的发布：TypeScript TypeScript 3.9 RC（2020-04-28）。标题可以热闹，决策还是得冷静。
...
一手入口在这里：<https://github.com/microsoft/TypeScript/releases/tag/v3.9-rc>
...
| --- | --- |
| 工具 / 项目 | TypeScript |
| 发布名称 | TypeScript 3.9 RC |
| 版本标签 | v3.9-rc |
| 原始发布日期 | 2020-04-28 |
| 是否预发布 | 是（候选版或预发布版本） |
| 仓库 | microsoft/TypeScript |
| 官方发布页 | [查看原文](https://github.com/microsoft/TypeScript/releases/tag/v3.9-rc) |
...
对 TypeScript（TypeScript 3.9 RC / v3.9-rc），建议按下列层面对齐阅读，而不是只扫版本号：
