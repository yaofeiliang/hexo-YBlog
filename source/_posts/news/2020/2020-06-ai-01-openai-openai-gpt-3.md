---
title: "[行业观察] OpenAI 发布 GPT-3 论文与能力说明：给非研究员的实用导读"
date: 2020-06-30 10:00:00
updated: 2020-06-30 10:00:00
description: "人工智能｜OpenAI 发布 GPT-3 论文与能力说明。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2020/ai-openai-openai-gpt-3/
categories:
  - 资讯
tags:
  - 行业资讯
...
2020-06-30 的「OpenAI 发布 GPT-3 论文与能力说明」值得停一下。AI 圈从不缺口号，缺的是把边界讲清楚。

OpenAI 在 **2020-06-30** 留下可核对记录：**OpenAI 发布 GPT-3 论文与能力说明**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
| 时间 | 2020-06-30 |
| 主体 | OpenAI |
| 事件 | OpenAI 发布 GPT-3 论文与能力说明 |
| 一手入口 | [阅读原文](https://openai.com/index/language-models-are-few-shot-learners/) |
| 收录月 | 2020-06 |
...
请用下面的分析骨架阅读「OpenAI 发布 GPT-3 论文与能力说明」，它比单靠情绪词汇更接近机构研报的工作方式：
...
- **few-shot：** 只给少量例子就能完成新任务
- **缩放定律：** 模型变大常伴随能力提升的经验规律
- **上下文：** 模型一次能参考的信息范围
...
- 原始日期：2020-06-30
- 收录月份：2020-06
- 一手链接：<https://openai.com/index/language-models-are-few-shot-learners/>
