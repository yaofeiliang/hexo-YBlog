---
title: "[行业观察] Hugging Face Transformers Patch v2.5.1: AutoTokenizer slow by default, bug fixes：别被演示绕晕，先看成本和边界"
date: 2020-02-24 10:00:00
updated: 2020-02-24 10:00:00
description: "人工智能｜Hugging Face Transformers Patch v2.5.1: AutoTokenizer slow by default, bug fixes。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
...
Hugging Face Transformers 在 **2020-02-24** 留下可核对记录：**Hugging Face Transformers Patch v2.5.1: AutoTokenizer slow by default, bug fixes**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
| 一手入口 | [阅读原文](https://github.com/huggingface/transformers/releases/tag/v2.5.1) |
| 收录月 | 2020-02 |
...
- **公开信息：** AutoTokenizer AutoTokenizer has been put back to False by default so as to not have a breaking change between 2.4.x and 2.5.x Fast tokenizers Bug fixes Slow tokenizers Bug fixes related to batchencodeplus
...
- **公开信息：** Hugging Face Transformers 通过公开页面发布了与「Hugging Face Transformers Patch v2.5.1: AutoTokenizer slow by default, bug fixes」相关的信息，供市场与开发者核对。
...
请用下面的分析骨架阅读「Hugging Face Transformers Patch v2.5.1: AutoTokenizer slow by default, bug fixes」，它比单靠情绪词汇更接近机构研报的工作方式：
