---
title: "[行业观察] Solana Testnet - v1.4.12：比行情截图更值得读的部分"
date: 2020-11-26 10:00:00
updated: 2020-11-26 10:00:00
description: "区块链｜Solana Testnet - v1.4.12。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2020/blockchain-solana-solana-testnet-v1-4-12/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v1.4.12
source_published: 2020-11-26
...
Solana 在 **2020-11-26** 留下可核对记录：**Solana Testnet - v1.4.12**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 时间 | 2020-11-26 |
| 主体 | Solana |
| 事件 | Solana Testnet - v1.4.12 |
| 一手入口 | [阅读原文](https://github.com/solana-labs/solana/releases/tag/v1.4.12) |
| 收录月 | 2020-11 |
...
- **公开信息：** Add "base64+zstd" encoding for fetching RPC account data
...
- **公开信息：** Nonce stability improvements
...
- **公开信息：** program-test now automatically adds SPL accounts to reduce test boilerplate
- **阅读提醒：** 能力扩展信号：先判断它解决的是产品瓶颈、工程效率还是可观测性，再排优先级。
...
- **公开信息：** RPC getConfirmedBlock and getBlockTime methods no longer inconsistent results to the caller depending on whether the node supports BigTable long-term storage
- **阅读提醒：** 能力扩展信号：先判断它解决的是产品瓶颈、工程效率还是可观测性，再排优先级。
- **我想追问的：** 失败或误解的代价由谁承担：用户、平台，还是机构？
- **可执行翻译：** 若相关，就开一个 30 分钟验证任务；若不相关，也明确写“暂不跟”。
...
- **公开信息：** Fix floating point math inaccuracies in solana-tokens
...
- **公开信息：** macOS binaries are not available
- **阅读提醒：** 把它当作待核验的工程信号：回到模块、配置键与调用链，确认是否命中你们的依赖图。
- **我想追问的：** 生效时间是立刻、分阶段，还是仍在征求意见？
- **可执行翻译：** 把该点写进团队周报的“外部变量”一栏，并指定一位核对人。
...
对「Solana Testnet - v1.4.12」做专业诊断时，先定位它主要改写的是结构、激励，还是约束。三者抓错，后续讨论会全程错位。

请用下面的分析骨架阅读「Solana Testnet - v1.4.12」，它比单靠情绪词汇更接近机构研报的工作方式：
...
- 原始日期：2020-11-26
- 收录月份：2020-11
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v1.4.12>
