---
title: "[行业观察] Solana v1.2.7：把链上黑话翻译成人话"
date: 2020-06-30 10:00:00
updated: 2020-06-30 10:00:00
description: "区块链｜Solana v1.2.7。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2020/blockchain-solana-solana-v1-2-7/
categories:
  - 资讯
tags:
  - 行业资讯
...
Solana 在 **2020-06-30** 留下可核对记录：**Solana v1.2.7**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 主体 | Solana |
| 事件 | Solana v1.2.7 |
| 一手入口 | [阅读原文](https://github.com/solana-labs/solana/releases/tag/v1.2.7) |
| 收录月 | 2020-06 |
...
- **公开信息：** Fix edge case in HeaviestForkChoice path selection when a subtree has no children with any votes: 10807
...
- **公开信息：** Dont skip eager rent collect across gapped epochs (10206) (10808)
...
- **公开信息：** Fix case where ledger cleanup can take a long time and cause the validator to go delinquent.10830
- **阅读提醒：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
- **公开信息：** Add more replay stage metrics and reduce lines of logging
...
对「Solana v1.2.7」做专业诊断时，先定位它主要改写的是结构、激励，还是约束。三者抓错，后续讨论会全程错位。

请用下面的分析骨架阅读「Solana v1.2.7」，它比单靠情绪词汇更接近机构研报的工作方式：
