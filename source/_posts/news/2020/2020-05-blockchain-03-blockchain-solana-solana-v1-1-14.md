---
title: "[行业观察] Solana v1.1.14：热闹背后的规则变化"
date: 2020-05-27 10:00:00
updated: 2020-05-27 10:00:00
description: "区块链领域关键节点：Solana v1.1.14。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2020/blockchain-blockchain-solana-solana-v1-1-14/
categories:
  - 资讯
tags:
  - 行业资讯
...
Solana 在 **2020-05-27** 留下了一条可核对的公开记录：**Solana v1.1.14**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **主体：** Solana
- **事件：** Solana v1.1.14
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v1.1.14)
