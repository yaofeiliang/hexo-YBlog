---
title: "[行业观察] 以太坊完成信标链上线（PoS 序章）：热闹背后的规则变化"
date: 2020-12-01 10:00:00
updated: 2020-12-01 10:00:00
description: "区块链领域关键节点：以太坊完成信标链上线（PoS 序章）。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2020/blockchain-blockchain-ethereum-foundation-pos/
categories:
  - 资讯
tags:
  - 行业资讯
...
链上故事最怕两种声音：一种只喊“要上天”，一种只喊“要归零”。以太坊完成信标链上线（PoS 序章） 属于第三种：值得把规则读完。

Ethereum Foundation 在 **2020-12-01** 留下了一条可核对的公开记录：**以太坊完成信标链上线（PoS 序章）**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **一手入口：** [点这里看原文](https://blog.ethereum.org/2020/12/01/eth2-quick-update-no-21)
