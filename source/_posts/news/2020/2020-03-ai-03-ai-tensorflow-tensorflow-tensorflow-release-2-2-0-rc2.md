---
title: "[行业观察] TensorFlow TensorFlow Release 2.2.0-rc2：这次更新到底动了谁的奶酪"
date: 2020-03-27 10:00:00
updated: 2020-03-27 10:00:00
description: "人工智能领域关键节点：TensorFlow TensorFlow Release 2.2.0-rc2。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2020/ai-ai-tensorflow-tensorflow-tensorflow-release-2-2-0-rc2/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/tensorflow/tensorflow/releases/tag/v2.2.0-rc2
source_published: 2020-03-27
...
如果说 AI 是一场连续剧，那么「TensorFlow TensorFlow Release 2.2.0-rc2」就是那集人人都在刷弹幕的高潮。

TensorFlow 在 **2020-03-27** 留下了一条可核对的公开记录：**TensorFlow TensorFlow Release 2.2.0-rc2**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **时间：** 2020-03-27
- **主体：** TensorFlow
- **事件：** TensorFlow TensorFlow Release 2.2.0-rc2
- **一手入口：** [点这里看原文](https://github.com/tensorflow/tensorflow/releases/tag/v2.2.0-rc2)
...
- 原始日期：2020-03-27
- 收录月份：2020-03
- 一手链接：<https://github.com/tensorflow/tensorflow/releases/tag/v2.2.0-rc2>
