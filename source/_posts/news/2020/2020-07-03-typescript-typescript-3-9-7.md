---
title: "[技术观察] TypeScript TypeScript 3.9.7：类型系统升级前的兼容性提示"
date: 2020-07-16 09:00:00
updated: 2020-07-16 09:00:00
description: "TypeScript 于 2020-07-16 发布 TypeScript 3.9.7。用通俗语言梳理工具背景、官方发布说明与升级检查步骤。"
permalink: news/2020/typescript-typescript-3-9-7/
categories:
  - 资讯
tags:
  - 技术资讯
...
source_url: https://github.com/microsoft/TypeScript/releases/tag/v3.9.7
source_published: 2020-07-16
...
TypeScript 在 **2020-07-16** 发布了 **TypeScript 3.9.7**。如果你已经在项目里使用它，这条发布记录值得先收藏：它是判断“要不要升级、升级前该检查什么”的官方入口；如果你还没用过它，也可以把本文当作认识这项工具的一次入门阅读。
...
| --- | --- |
| 工具 / 项目 | TypeScript |
| 发布名称 | TypeScript 3.9.7 |
| 版本标签 | v3.9.7 |
| 原始发布日期 | 2020-07-16 |
| 是否预发布 | 否（正式发布版本） |
| 官方发布页 | [查看原文](https://github.com/microsoft/TypeScript/releases/tag/v3.9.7) |
...
- 原始发布日期：2020-07-16
- 收录月份：2020-07
- 发布页：<https://github.com/microsoft/TypeScript/releases/tag/v3.9.7>
