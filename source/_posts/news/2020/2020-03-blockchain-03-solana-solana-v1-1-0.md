---
title: "[行业观察] Solana v1.1.0：把链上黑话翻译成人话"
date: 2020-03-31 10:00:00
updated: 2020-03-31 10:00:00
description: "区块链｜Solana v1.1.0。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2020/blockchain-solana-solana-v1-1-0/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v1.1.0
source_published: 2020-03-31
...
Solana 在 **2020-03-31** 留下可核对记录：**Solana v1.1.0**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 主体 | Solana |
| 事件 | Solana v1.1.0 |
| 一手入口 | [阅读原文](https://github.com/solana-labs/solana/releases/tag/v1.1.0) |
| 收录月 | 2020-03 |
...
- **公开信息：** Polish, bug fixes, and documentation improvements across the board.
...
- **公开信息：** New solana-stake-accounts command-line tool for managing stake accounts
...
请用下面的分析骨架阅读「Solana v1.1.0」，它比单靠情绪词汇更接近机构研报的工作方式：
...
- 原始日期：2020-03-31
- 收录月份：2020-03
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v1.1.0>
