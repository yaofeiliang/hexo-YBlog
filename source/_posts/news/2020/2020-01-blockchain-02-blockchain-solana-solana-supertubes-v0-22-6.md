---
title: "[行业观察] Solana Supertubes v0.22.6：热闹背后的规则变化"
date: 2020-01-30 10:00:00
updated: 2020-01-30 10:00:00
description: "区块链领域关键节点：Solana Supertubes v0.22.6。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2020/blockchain-blockchain-solana-solana-supertubes-v0-22-6/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v0.22.6
source_published: 2020-01-30
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 Solana Supertubes v0.22.6。

Solana 在 **2020-01-30** 留下了一条可核对的公开记录：**Solana Supertubes v0.22.6**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2020-01-30
- **主体：** Solana
- **事件：** Solana Supertubes v0.22.6
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v0.22.6)

根据可核验公开材料，关键信息可以概括为：

- Turbine now ignores staked validators with a different shred version
- RPC getClusterNodes now excludes validators with a different shred version
- Validators now wait for a supermajority of stake by default, add --no-wait-for-supermajority flag to override.
- Add --expected-shred-version option to solana-validator
...
- 原始日期：2020-01-30
- 收录月份：2020-01
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v0.22.6>
