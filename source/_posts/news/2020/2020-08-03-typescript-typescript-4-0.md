---
title: "[技术观察] TypeScript TypeScript 4.0：别只看版本号，先看你会不会被影响"
date: 2020-08-20 09:00:00
updated: 2020-08-20 09:00:00
description: "TypeScript 于 2020-08-20 发布 TypeScript 4.0。结合官方条目、场景推演与升级检查，帮你判断要不要跟、怎么跟。"
...
又一条值得记账的发布：TypeScript TypeScript 4.0（2020-08-20）。标题可以热闹，决策还是得冷静。
...
一手入口在这里：<https://github.com/microsoft/TypeScript/releases/tag/v4.0.2>
...
| 官方发布页 | [查看原文](https://github.com/microsoft/TypeScript/releases/tag/v4.0.2) |
...
- **官方原文：** fixed issues query for TypeScript v4.0.0 (Beta).
  - **怎么读：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
- **官方原文：** fixed issues query for TypeScript v4.0.1 (RC).
  - **怎么读：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
- **官方原文：** fixed issues query for TypeScript v4.0.2.
  - **怎么读：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
对 TypeScript（TypeScript 4.0 / v4.0.2），建议按下列层面对齐阅读，而不是只扫版本号：
