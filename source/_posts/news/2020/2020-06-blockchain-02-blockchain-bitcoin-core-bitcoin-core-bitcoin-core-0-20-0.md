---
title: "[行业观察] Bitcoin Core Bitcoin Core 0.20.0：热闹背后的规则变化"
date: 2020-06-03 10:00:00
updated: 2020-06-03 10:00:00
description: "区块链领域关键节点：Bitcoin Core Bitcoin Core 0.20.0。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2020/blockchain-blockchain-bitcoin-core-bitcoin-core-bitcoin-core-0-20-0/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/bitcoin/bitcoin/releases/tag/v0.20.0
source_published: 2020-06-03
...
Bitcoin Core 在 **2020-06-03** 留下了一条可核对的公开记录：**Bitcoin Core Bitcoin Core 0.20.0**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2020-06-03
- **主体：** Bitcoin Core
- **事件：** Bitcoin Core Bitcoin Core 0.20.0
- **一手入口：** [点这里看原文](https://github.com/bitcoin/bitcoin/releases/tag/v0.20.0)
...
- 原始日期：2020-06-03
- 收录月份：2020-06
- 一手链接：<https://github.com/bitcoin/bitcoin/releases/tag/v0.20.0>
