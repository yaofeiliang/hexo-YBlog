...
description: "Babel 于 2020-12-23 发布 v7.12.12。用通俗语言梳理工具背景、官方发布说明与升级检查步骤。"
...
Babel 在 **2020-12-23** 发布了 **v7.12.12**。如果你已经在项目里使用它，这条发布记录值得先收藏：它是判断“要不要升级、升级前该检查什么”的官方入口；如果你还没用过它，也可以把本文当作认识这项工具的一次入门阅读。
...
| 原始发布日期 | 2020-12-23 |
| 是否预发布 | 否（正式发布版本） |
| 官方发布页 | [查看原文](https://github.com/babel/babel/releases/tag/v7.12.12) |
...
- #12530 skip discriminant when renamer starts from SwitchStatement (@Zzzen)
- babel-types
- #12521 Restore @babel/types support for old TS versions (@nicolo-ribaudo)
...
- babel-polyfill
- #12541 Archive @babel/polyfill (@nicolo-ribaudo)
...
- #12524 refactor: Move react-jsx-development implementation into react-jsx (@nicolo-ribaudo)
...
- #12130 Remove babel polyfill from fixture test runner (@JLHwung)

### Committers: 4

- Other
- #12527 Update release-tool and define implicit deps for @babel/runtime (@nicolo-ribaudo)
- #12011 Enable PnP linker on CI build job (@JLHwung)
- Babel Bot (@babel-bot)
