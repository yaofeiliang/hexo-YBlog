---
title: "[行业观察] Bitcoin Core Bitcoin Core 0.19.0.1：热闹背后的规则变化"
date: 2019-11-24 10:00:00
updated: 2019-11-24 10:00:00
description: "区块链领域关键节点：Bitcoin Core Bitcoin Core 0.19.0.1。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2019/blockchain-blockchain-bitcoin-core-bitcoin-core-bitcoin-core-0-19-0-1/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/bitcoin/bitcoin/releases/tag/v0.19.0.1
source_published: 2019-11-24
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 Bitcoin Core Bitcoin Core 0.19.0.1。

Bitcoin Core 在 **2019-11-24** 留下了一条可核对的公开记录：**Bitcoin Core Bitcoin Core 0.19.0.1**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2019-11-24
- **主体：** Bitcoin Core
- **事件：** Bitcoin Core Bitcoin Core 0.19.0.1
- **一手入口：** [点这里看原文](https://github.com/bitcoin/bitcoin/releases/tag/v0.19.0.1)

根据可核验公开材料，关键信息可以概括为：

- Bitcoin Core version 0.19.0.1 is now available from: https://bitcoincore.org/bin/bitcoin-core-0.19.0.1/ For the release notes please see the git repository: https://github.com/bitcoin/bitcoin/blob/master/doc/release-notes/release-notes-0.19.0.1.md Preferably use the above download link, not the links provided by GitHub to download the source tarball, as the release tarballs are generated deterministically whereas GitHub's are not.
...
- 原始日期：2019-11-24
- 收录月份：2019-11
- 一手链接：<https://github.com/bitcoin/bitcoin/releases/tag/v0.19.0.1>
