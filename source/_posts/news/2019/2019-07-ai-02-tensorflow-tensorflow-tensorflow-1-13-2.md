---
title: "[行业观察] TensorFlow TensorFlow 1.13.2：别被演示绕晕，先看成本和边界"
date: 2019-07-16 10:00:00
updated: 2019-07-16 10:00:00
description: "人工智能｜TensorFlow TensorFlow 1.13.2。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2019/ai-tensorflow-tensorflow-tensorflow-1-13-2/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/tensorflow/tensorflow/releases/tag/v1.13.2
...
TensorFlow 在 **2019-07-16** 留下可核对记录：**TensorFlow TensorFlow 1.13.2**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
| 时间 | 2019-07-16 |
| 主体 | TensorFlow |
| 事件 | TensorFlow TensorFlow 1.13.2 |
| 一手入口 | [阅读原文](https://github.com/tensorflow/tensorflow/releases/tag/v1.13.2) |
| 收录月 | 2019-07 |
...
- **公开信息：** Updates pngarchive dependency to 1.6.37 to not be affected by CVE-2019-7317, CVE-2018-13785, and CVE-2018-14048.
...
- **公开信息：** Updates sqlite dependency to 3.28.0 to not be affected by CVE-2018-20506, CVE-2018-20346, and CVE-2018-20505.
- **阅读提醒：** 安全信号：优先核对受影响组件与暴露面，再决定是热修、灰度还是冻结发布窗口。
...
- **公开信息：** TensorFlow 通过公开页面发布了与「TensorFlow TensorFlow 1.13.2」相关的信息，供市场与开发者核对。
...
请用下面的分析骨架阅读「TensorFlow TensorFlow 1.13.2」，它比单靠情绪词汇更接近机构研报的工作方式：
...
- 原始日期：2019-07-16
- 收录月份：2019-07
- 一手链接：<https://github.com/tensorflow/tensorflow/releases/tag/v1.13.2>
