---
title: "[技术观察] TypeScript TypeScript 3.7.4：类型系统升级前的兼容性提示"
date: 2019-12-30 09:00:00
updated: 2019-12-30 09:00:00
description: "TypeScript 于 2019-12-30 发布 TypeScript 3.7.4。用通俗语言梳理工具背景、官方发布说明与升级检查步骤。"
permalink: news/2019/typescript-typescript-3-7-4/
categories:
  - 资讯
tags:
  - 技术资讯
...
source_url: https://github.com/microsoft/TypeScript/releases/tag/v3.7.4
source_published: 2019-12-30
...
TypeScript 在 **2019-12-30** 发布了 **TypeScript 3.7.4**。如果你已经在项目里使用它，这条发布记录值得先收藏：它是判断“要不要升级、升级前该检查什么”的官方入口；如果你还没用过它，也可以把本文当作认识这项工具的一次入门阅读。
...
| --- | --- |
| 工具 / 项目 | TypeScript |
| 发布名称 | TypeScript 3.7.4 |
| 版本标签 | v3.7.4 |
| 原始发布日期 | 2019-12-30 |
| 是否预发布 | 否（正式发布版本） |
| 官方发布页 | [查看原文](https://github.com/microsoft/TypeScript/releases/tag/v3.7.4) |
...
- 原始发布日期：2019-12-30
- 收录月份：2019-12
- 发布页：<https://github.com/microsoft/TypeScript/releases/tag/v3.7.4>

## 来源与声明

- 本文是对官方发布记录的后期整理，不代表姚飞亮在 2019-12 已在本站发表本文。
