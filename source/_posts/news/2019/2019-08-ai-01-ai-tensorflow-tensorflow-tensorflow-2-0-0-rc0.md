---
title: "[行业观察] TensorFlow TensorFlow 2.0.0-rc0：这次更新到底动了谁的奶酪"
date: 2019-08-23 10:00:00
updated: 2019-08-23 10:00:00
description: "人工智能领域关键节点：TensorFlow TensorFlow 2.0.0-rc0。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2019/ai-ai-tensorflow-tensorflow-tensorflow-2-0-0-rc0/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/tensorflow/tensorflow/releases/tag/v2.0.0-rc0
source_published: 2019-08-23
...
又到了把咖啡放下、把官方链接点开的时刻：TensorFlow TensorFlow 2.0.0-rc0。

TensorFlow 在 **2019-08-23** 留下了一条可核对的公开记录：**TensorFlow TensorFlow 2.0.0-rc0**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **时间：** 2019-08-23
- **主体：** TensorFlow
- **事件：** TensorFlow TensorFlow 2.0.0-rc0
- **一手入口：** [点这里看原文](https://github.com/tensorflow/tensorflow/releases/tag/v2.0.0-rc0)
...
- 原始日期：2019-08-23
- 收录月份：2019-08
- 一手链接：<https://github.com/tensorflow/tensorflow/releases/tag/v2.0.0-rc0>
