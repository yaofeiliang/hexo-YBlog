---
title: "[行业观察] PyTorch New TorchScript API with Improved Python Language Coverage, Expanded ONNX Export, NN.Transformer：这次更新到底动了谁的奶酪"
date: 2019-08-08 10:00:00
updated: 2019-08-08 10:00:00
description: "人工智能领域关键节点：PyTorch New TorchScript API with Improved Python Language Coverage, Expanded ONNX Export, NN.Transformer。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2019/ai-ai-pytorch-pytorch-new-torchscript-api-with-improved-python-/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/pytorch/pytorch/releases/tag/v1.2.0
source_published: 2019-08-08
...
PyTorch 在 **2019-08-08** 留下了一条可核对的公开记录：**PyTorch New TorchScript API with Improved Python Language Coverage, Expanded ONNX Export, NN.Transformer**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **时间：** 2019-08-08
- **主体：** PyTorch
- **事件：** PyTorch New TorchScript API with Improved Python Language Coverage, Expanded ONNX Export, NN.Transformer
- **一手入口：** [点这里看原文](https://github.com/pytorch/pytorch/releases/tag/v1.2.0)
...
- 原始日期：2019-08-08
- 收录月份：2019-08
- 一手链接：<https://github.com/pytorch/pytorch/releases/tag/v1.2.0>
