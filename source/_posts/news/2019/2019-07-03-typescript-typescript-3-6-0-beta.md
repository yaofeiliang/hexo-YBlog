---
title: "[技术观察] TypeScript TypeScript 3.6.0 Beta：把发布说明读成可执行的检查单"
date: 2019-07-19 09:00:00
updated: 2019-07-19 09:00:00
description: "TypeScript 于 2019-07-19 发布 TypeScript 3.6.0 Beta。结合官方条目、场景推演与升级检查，帮你判断要不要跟、怎么跟。"
...
又一条值得记账的发布：TypeScript TypeScript 3.6.0 Beta（2019-07-19）。标题可以热闹，决策还是得冷静。
...
一手入口在这里：<https://github.com/microsoft/TypeScript/releases/tag/v3.6-beta>
...
| --- | --- |
| 工具 / 项目 | TypeScript |
| 发布名称 | TypeScript 3.6.0 Beta |
| 版本标签 | v3.6-beta |
| 原始发布日期 | 2019-07-19 |
| 是否预发布 | 是（候选版或预发布版本） |
| 仓库 | microsoft/TypeScript |
| 官方发布页 | [查看原文](https://github.com/microsoft/TypeScript/releases/tag/v3.6-beta) |
...
- **官方原文：** fixed issues query for TypeScript 3.6 Beta.
...
对 TypeScript（TypeScript 3.6.0 Beta / v3.6-beta），建议按下列层面对齐阅读，而不是只扫版本号：
