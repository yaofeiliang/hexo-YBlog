...
description: "Babel 于 2019-05-21 发布 v7.4.5。用通俗语言梳理工具背景、官方发布说明与升级检查步骤。"
...
Babel 在 **2019-05-21** 发布了 **v7.4.5**。如果你已经在项目里使用它，这条发布记录值得先收藏：它是判断“要不要升级、升级前该检查什么”的官方入口；如果你还没用过它，也可以把本文当作认识这项工具的一次入门阅读。
...
| 原始发布日期 | 2019-05-21 |
| 是否预发布 | 否（正式发布版本） |
| 官方发布页 | [查看原文](https://github.com/babel/babel/releases/tag/v7.4.5) |
...
- babel-parser
- #9998 Fix location for optional params in arrow functions (@danez)
- #9982 Avoid unnecessary work during lookahead (@danez)
- #9922 fix: allow shebang directive (@tanhauhau)
- babel-preset-env
- #10002 Update preset-env dependencies and fix fixtures (@danez)

### :nailcare: Polish

- #9978 Fix mobile browsers support in preset-env (@nicolo-ribaudo)
- #9902 Fix destructuring assignments being transpiled for edge 15 (@eps1lon)
- babel-plugin-transform-typescript
- #9944 fix(typescript): erase type exports (@airato)
- babel-parser
...
- babel-preset-env
- #9992 use console.warn for warning (@schu34)
- babel-core
