---
title: "[行业观察] go-ethereum Elasa (v1.9.6)：先看规则，再看热闹"
date: 2019-10-03 10:00:00
updated: 2019-10-03 10:00:00
description: "区块链｜go-ethereum Elasa (v1.9.6)。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2019/blockchain-go-ethereum-go-ethereum-elasa-v1-9-6/
categories:
  - 资讯
tags:
  - 行业资讯
...
go-ethereum 在 **2019-10-03** 留下可核对记录：**go-ethereum Elasa (v1.9.6)**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 一手入口 | [阅读原文](https://github.com/ethereum/go-ethereum/releases/tag/v1.9.6) |
| 收录月 | 2019-10 |
...
- **公开信息：** LES servers now advertise the les capability via ENR (20145)
...
- **公开信息：** New metrics for p2p bandwidth per protocol message (20133)
...
- **公开信息：** LevelDB seek compaction is disabled, reducing disk I/O (20130)
- **阅读提醒：** 把它当作待核验的工程信号：回到模块、配置键与调用链，确认是否命中你们的依赖图。
...
- **公开信息：** Handling of invalid future blocks is improved (19763)
- **阅读提醒：** 把它当作待核验的工程信号：回到模块、配置键与调用链，确认是否命中你们的依赖图。
...
请用下面的分析骨架阅读「go-ethereum Elasa (v1.9.6)」，它比单靠情绪词汇更接近机构研报的工作方式：
