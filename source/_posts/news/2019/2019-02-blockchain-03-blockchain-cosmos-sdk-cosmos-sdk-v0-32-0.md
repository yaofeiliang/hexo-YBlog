---
title: "[行业观察] Cosmos SDK v0.32.0：热闹背后的规则变化"
date: 2019-02-18 10:00:00
updated: 2019-02-18 10:00:00
description: "区块链领域关键节点：Cosmos SDK v0.32.0。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2019/blockchain-blockchain-cosmos-sdk-cosmos-sdk-v0-32-0/
categories:
  - 资讯
tags:
  - 行业资讯
...
链上故事最怕两种声音：一种只喊“要上天”，一种只喊“要归零”。Cosmos SDK v0.32.0 属于第三种：值得把规则读完。

Cosmos SDK 在 **2019-02-18** 留下了一条可核对的公开记录：**Cosmos SDK v0.32.0**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **一手入口：** [点这里看原文](https://github.com/cosmos/cosmos-sdk/releases/tag/v0.32.0)
