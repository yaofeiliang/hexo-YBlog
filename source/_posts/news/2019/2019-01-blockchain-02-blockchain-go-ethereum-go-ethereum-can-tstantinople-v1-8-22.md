---
title: "[行业观察] go-ethereum Can'tstantinople (v1.8.22)：热闹背后的规则变化"
date: 2019-01-31 10:00:00
updated: 2019-01-31 10:00:00
description: "区块链领域关键节点：go-ethereum Can'tstantinople (v1.8.22)。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2019/blockchain-blockchain-go-ethereum-go-ethereum-can-tstantinople-v1-8-22/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/ethereum/go-ethereum/releases/tag/v1.8.22
...
go-ethereum 在 **2019-01-31** 留下了一条可核对的公开记录：**go-ethereum Can'tstantinople (v1.8.22)**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2019-01-31
- **主体：** go-ethereum
- **事件：** go-ethereum Can'tstantinople (v1.8.22)
- **一手入口：** [点这里看原文](https://github.com/ethereum/go-ethereum/releases/tag/v1.8.22)
...
- 原始日期：2019-01-31
- 收录月份：2019-01
- 一手链接：<https://github.com/ethereum/go-ethereum/releases/tag/v1.8.22>
