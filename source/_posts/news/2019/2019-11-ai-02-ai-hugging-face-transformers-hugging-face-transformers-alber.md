---
title: "[行业观察] Hugging Face Transformers ALBERT, CamemBERT, DistilRoberta, GPT-2 XL, and Encoder-Decoder architectures：这次更新到底动了谁的奶酪"
date: 2019-11-26 10:00:00
updated: 2019-11-26 10:00:00
description: "人工智能领域关键节点：Hugging Face Transformers ALBERT, CamemBERT, DistilRoberta, GPT-2 XL, and Encoder-Decoder architectures。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2019/ai-ai-hugging-face-transformers-hugging-face-transformers-alber/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/huggingface/transformers/releases/tag/v2.2.0
source_published: 2019-11-26
...
又到了把咖啡放下、把官方链接点开的时刻：Hugging Face Transformers ALBERT, CamemBERT, DistilRoberta, GPT-2 XL, and Encoder-Decoder architectures。

Hugging Face Transformers 在 **2019-11-26** 留下了一条可核对的公开记录：**Hugging Face Transformers ALBERT, CamemBERT, DistilRoberta, GPT-2 XL, and Encoder-Decoder architectures**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **事件：** Hugging Face Transformers ALBERT, CamemBERT, DistilRoberta, GPT-2 XL, and Encoder-Decoder architectures
- **一手入口：** [点这里看原文](https://github.com/huggingface/transformers/releases/tag/v2.2.0)
...
- 原始日期：2019-11-26
- 收录月份：2019-11
- 一手链接：<https://github.com/huggingface/transformers/releases/tag/v2.2.0>
