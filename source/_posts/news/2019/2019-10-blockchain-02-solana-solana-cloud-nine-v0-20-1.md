---
title: "[行业观察] Solana Cloud Nine v0.20.1：把链上黑话翻译成人话"
date: 2019-10-30 10:00:00
updated: 2019-10-30 10:00:00
description: "区块链｜Solana Cloud Nine v0.20.1。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2019/blockchain-solana-solana-cloud-nine-v0-20-1/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v0.20.1
...
Solana 在 **2019-10-30** 留下可核对记录：**Solana Cloud Nine v0.20.1**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 时间 | 2019-10-30 |
| 主体 | Solana |
| 事件 | Solana Cloud Nine v0.20.1 |
| 一手入口 | [阅读原文](https://github.com/solana-labs/solana/releases/tag/v0.20.1) |
| 收录月 | 2019-10 |
...
- **公开信息：** Fixed Turbine broadcast calculation that was causing cluster boot failures
...
- **公开信息：** Resolved excessive shred log messages
- **阅读提醒：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
- **公开信息：** Fixed airdrop issue with Solana docker image
- **阅读提醒：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
请用下面的分析骨架阅读「Solana Cloud Nine v0.20.1」，它比单靠情绪词汇更接近机构研报的工作方式：
...
- 原始日期：2019-10-30
- 收录月份：2019-10
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v0.20.1>
