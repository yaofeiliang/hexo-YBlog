---
title: "[行业观察] Solana Smart contract development via solana_runtime：热闹背后的规则变化"
date: 2019-03-11 10:00:00
updated: 2019-03-11 10:00:00
description: "区块链领域关键节点：Solana Smart contract development via solana_runtime。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2019/blockchain-blockchain-solana-solana-smart-contract-development-via-sola/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v0.12.0
source_published: 2019-03-11
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 Solana Smart contract development via solana_runtime。

Solana 在 **2019-03-11** 留下了一条可核对的公开记录：**Solana Smart contract development via solana_runtime**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2019-03-11
- **主体：** Solana
- **事件：** Solana Smart contract development via solana_runtime
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v0.12.0)
...
- 原始日期：2019-03-11
- 收录月份：2019-03
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v0.12.0>

## 来源与声明

- 本文是对官方公开信息的后期整理，不代表姚飞亮在 2019-03 已在本站发表本文。
