---
title: "[行业观察] Hugging Face Transformers CTRL, DistilGPT-2, Pytorch TPU, tokenizer enhancements, guideline requirements：这次更新到底动了谁的奶酪"
date: 2019-10-11 10:00:00
updated: 2019-10-11 10:00:00
description: "人工智能领域关键节点：Hugging Face Transformers CTRL, DistilGPT-2, Pytorch TPU, tokenizer enhancements, guideline requirements。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2019/ai-ai-hugging-face-transformers-hugging-face-transformers-ctrl-/
categories:
  - 资讯
tags:
  - 行业资讯
...
Hugging Face Transformers 在 **2019-10-11** 留下了一条可核对的公开记录：**Hugging Face Transformers CTRL, DistilGPT-2, Pytorch TPU, tokenizer enhancements, guideline requirements**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **一手入口：** [点这里看原文](https://github.com/huggingface/transformers/releases/tag/v2.1.1)
...
- runmultiplechoice.py has been refactored to include encodeplus by @julien-c and @erenup
- runlmfinetuning.py has been improved with the help of @dennymarcels, @jinoobaek-qz and @LysandreJik
