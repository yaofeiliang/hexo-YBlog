---
title: "[行业观察] Solana Tour de SOL Stage 1, Bring it：热闹背后的规则变化"
date: 2019-10-28 10:00:00
updated: 2019-10-28 10:00:00
description: "区块链领域关键节点：Solana Tour de SOL Stage 1, Bring it。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2019/blockchain-blockchain-solana-solana-tour-de-sol-stage-1-bring-it/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v0.20.0
...
链上故事最怕两种声音：一种只喊“要上天”，一种只喊“要归零”。Solana Tour de SOL Stage 1, Bring it 属于第三种：值得把规则读完。

Solana 在 **2019-10-28** 留下了一条可核对的公开记录：**Solana Tour de SOL Stage 1, Bring it**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2019-10-28
- **主体：** Solana
- **事件：** Solana Tour de SOL Stage 1, Bring it
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v0.20.0)
...
- https://github.com/solana-labs/solana/issues/6578 - Move support is not enabled by in release binaries or testnets, it currently must be built from source.
...
- 原始日期：2019-10-28
- 收录月份：2019-10
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v0.20.0>
