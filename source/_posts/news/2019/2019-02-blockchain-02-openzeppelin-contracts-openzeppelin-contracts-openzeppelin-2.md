---
title: "[行业观察] OpenZeppelin Contracts OpenZeppelin 2.1.3：比行情截图更值得读的部分"
date: 2019-02-26 10:00:00
updated: 2019-02-26 10:00:00
description: "区块链｜OpenZeppelin Contracts OpenZeppelin 2.1.3。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2019/blockchain-openzeppelin-contracts-openzeppelin-contracts-openzeppelin-2/
categories:
  - 资讯
tags:
  - 行业资讯
...
OpenZeppelin Contracts 在 **2019-02-26** 留下可核对记录：**OpenZeppelin Contracts OpenZeppelin 2.1.3**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 一手入口 | [阅读原文](https://github.com/OpenZeppelin/openzeppelin-contracts/releases/tag/v2.1.3) |
| 收录月 | 2019-02 |
...
- **公开信息：** Bugfix release :bug: :wrench: A minor issue with SafeERC20.safeApprove was identified and reported independently by @nikeshnazareth (thanks once again!), this release contains the correspondig fix: https://github.com/OpenZeppelin/openzeppelin-solidity/pull/1647.
...
- **公开信息：** This bug has been present since v2.0.0.
- **阅读提醒：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
- **公开信息：** Updating to this latest version is recommended, but no immediate emergency action should be required for production code using affected versions, due to the low severity of the issue.
...
- **公开信息：** These independent reviews are a great way to keep our code secure and correct: we'll be making a push for a properly funded bug bounty during these next weeks to continue encouraging them.
- **阅读提醒：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
请用下面的分析骨架阅读「OpenZeppelin Contracts OpenZeppelin 2.1.3」，它比单靠情绪词汇更接近机构研报的工作方式：
