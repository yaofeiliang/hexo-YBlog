---
title: "[行业观察] Solana Cloud Nine v0.20.1：热闹背后的规则变化"
date: 2019-10-30 10:00:00
updated: 2019-10-30 10:00:00
description: "区块链领域关键节点：Solana Cloud Nine v0.20.1。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2019/blockchain-blockchain-solana-solana-cloud-nine-v0-20-1/
categories:
  - 资讯
tags:
  - 行业资讯
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 Solana Cloud Nine v0.20.1。

Solana 在 **2019-10-30** 留下了一条可核对的公开记录：**Solana Cloud Nine v0.20.1**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v0.20.1)

根据可核验公开材料，关键信息可以概括为：

- Fixed Turbine broadcast calculation that was causing cluster boot failures
- Resolved excessive shred log messages
- Fixed airdrop issue with Solana docker image
