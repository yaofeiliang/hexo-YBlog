---
title: "[技术观察] TypeScript TypeScript 3.7.2：给忙碌开发者的人话导读"
date: 2019-11-06 09:00:00
updated: 2019-11-06 09:00:00
description: "TypeScript 于 2019-11-06 发布 TypeScript 3.7.2。结合官方条目、场景推演与升级检查，帮你判断要不要跟、怎么跟。"
...
TypeScript 在 2019-11-06 放出了 TypeScript 3.7.2。我建议你别急着点升级：先花两分钟搞清楚“它动到了哪一层”。
...
一手入口在这里：<https://github.com/microsoft/TypeScript/releases/tag/v3.7.2>
...
| --- | --- |
| 工具 / 项目 | TypeScript |
| 发布名称 | TypeScript 3.7.2 |
| 版本标签 | v3.7.2 |
| 原始发布日期 | 2019-11-06 |
| 是否预发布 | 否（正式发布版本） |
| 仓库 | microsoft/TypeScript |
| 官方发布页 | [查看原文](https://github.com/microsoft/TypeScript/releases/tag/v3.7.2) |
...
对 TypeScript（TypeScript 3.7.2 / v3.7.2），建议按下列层面对齐阅读，而不是只扫版本号：
