---
title: "[技术观察] TypeScript TypeScript 3.6.2：类型系统升级前的兼容性提示"
date: 2019-08-28 09:00:00
updated: 2019-08-28 09:00:00
description: "TypeScript 于 2019-08-28 发布 TypeScript 3.6.2。本文提炼升级关注点、官方说明摘要与实践检查项。"
permalink: /news/2019/typescript-typescript-3-6-2/
categories:
  - 资讯
tags:
  - 技术资讯
...
source_url: https://github.com/microsoft/TypeScript/releases/tag/v3.6.2
source_published: 2019-08-28
...
TypeScript 于 2019-08-28 发布「TypeScript 3.6.2」。这类版本发布通常不只是“更新一个版本号”：它会影响 维护 TypeScript 应用、库或声明文件的开发者 的依赖选择、升级节奏与验证成本。
...
- 原始发布日期：2019-08-28
- 收录月份：2019-08
- 发布页：<https://github.com/microsoft/TypeScript/releases/tag/v3.6.2>

## 来源与声明

- 本文是对官方发布记录的后期整理，不代表姚飞亮在 2019-08 已在本站发表本文。
