---
title: "[行业观察] Solana Smart Contracts via Move：热闹背后的规则变化"
date: 2019-07-30 10:00:00
updated: 2019-07-30 10:00:00
description: "区块链领域关键节点：Solana Smart Contracts via Move。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2019/blockchain-blockchain-solana-solana-smart-contracts-via-move/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v0.17.0
source_published: 2019-07-30
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 Solana Smart Contracts via Move。

Solana 在 **2019-07-30** 留下了一条可核对的公开记录：**Solana Smart Contracts via Move**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2019-07-30
- **主体：** Solana
- **事件：** Solana Smart Contracts via Move
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v0.17.0)
...
- 原始日期：2019-07-30
- 收录月份：2019-07
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v0.17.0>
