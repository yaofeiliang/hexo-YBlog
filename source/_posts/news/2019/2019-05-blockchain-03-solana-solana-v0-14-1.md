---
title: "[行业观察] Solana v0.14.1：比行情截图更值得读的部分"
date: 2019-05-03 10:00:00
updated: 2019-05-03 10:00:00
description: "区块链｜Solana v0.14.1。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2019/blockchain-solana-solana-v0-14-1/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v0.14.1
source_published: 2019-05-03
...
Solana v0.14.1 这类节点，适合当成“制度/协议变更”，而不是当成心情天气。

Solana 在 **2019-05-03** 留下可核对记录：**Solana v0.14.1**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 主体 | Solana |
| 事件 | Solana v0.14.1 |
| 一手入口 | [阅读原文](https://github.com/solana-labs/solana/releases/tag/v0.14.1) |
| 收录月 | 2019-05 |
...
- **公开信息：** Display release date in the local timezone
...
- **公开信息：** Add a node-specific ip echo service to remove dependency on ifconfig.co
...
- **公开信息：** Fix accountsdb storage.reset()
...
- **公开信息：** Various fixes for v0.14 for large clusters
- **阅读提醒：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
请用下面的分析骨架阅读「Solana v0.14.1」，它比单靠情绪词汇更接近机构研报的工作方式：
...
- 原始日期：2019-05-03
- 收录月份：2019-05
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v0.14.1>
