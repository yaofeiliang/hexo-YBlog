---
title: "[行业观察] TensorFlow TensorFlow 1.14.0-rc0：这次更新到底动了谁的奶酪"
date: 2019-05-24 10:00:00
updated: 2019-05-24 10:00:00
description: "人工智能领域关键节点：TensorFlow TensorFlow 1.14.0-rc0。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2019/ai-ai-tensorflow-tensorflow-tensorflow-1-14-0-rc0/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/tensorflow/tensorflow/releases/tag/v1.14.0-rc0
source_published: 2019-05-24
...
别急着会心一笑或焦虑失眠——先看清 TensorFlow 到底宣布了什么。

TensorFlow 在 **2019-05-24** 留下了一条可核对的公开记录：**TensorFlow TensorFlow 1.14.0-rc0**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **时间：** 2019-05-24
- **主体：** TensorFlow
- **事件：** TensorFlow TensorFlow 1.14.0-rc0
- **一手入口：** [点这里看原文](https://github.com/tensorflow/tensorflow/releases/tag/v1.14.0-rc0)
...
- Turn on MKL-DNN contraction kernels by default. MKL-DNN dynamically dispatches the best kernel implementation based on CPU vector architecture. To disable them, build with --define=tensorflowmkldnncontractionkernel=0.
- Set default loss reduction as AUTO for improving reliability of loss scaling with distribution strategy and custom training loops. AUTO indicates that the reduction option will be determined by the usage context. For almost all cases this defaults to SUMOVERBATCHSIZE. When used in distribution strategy scope, outside of built-in training loops such as tf.keras compile and fit, we expect reduction value to be 'None' or 'SUM'. Using other values will raise an error.
- Wraps losses passed to the compile API (strings and v1 losses) which are not instances of v2 Loss class in LossWrapper class. => All losses will now use SUMOVERBATCHSIZE reduction as default.
...
- 原始日期：2019-05-24
- 收录月份：2019-05
- 一手链接：<https://github.com/tensorflow/tensorflow/releases/tag/v1.14.0-rc0>
