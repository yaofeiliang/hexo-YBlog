---
title: "[行业观察] Hugging Face Transformers Bug fixes related to input shape in TensorFlow and tokenization messages：这次到底方便了谁"
date: 2019-12-03 10:00:00
updated: 2019-12-03 10:00:00
description: "人工智能｜Hugging Face Transformers Bug fixes related to input shape in TensorFlow and tokenization messages。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2019/ai-hugging-face-transformers-hugging-face-transformers-bug-fixe/
categories:
  - 资讯
tags:
  - 行业资讯
...
Hugging Face Transformers 在 **2019-12-03** 留下可核对记录：**Hugging Face Transformers Bug fixes related to input shape in TensorFlow and tokenization messages**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
| 一手入口 | [阅读原文](https://github.com/huggingface/transformers/releases/tag/v2.2.1) |
| 收录月 | 2019-12 |
...
- **公开信息：** Input shapes This patch fixes a bug related to the input shape in several models in TensorFlow.
...
- **公开信息：** Tokenization message A tokenization message was too present and overloaded the output, hiding the relevant information.
...
- **公开信息：** Hugging Face Transformers 通过公开页面发布了与「Hugging Face Transformers Bug fixes related to input shape in TensorFlow and tokenization messages」相关的信息，供市场与开发者核对。
- **阅读提醒：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
请用下面的分析骨架阅读「Hugging Face Transformers Bug fixes related to input shape in TensorFlow and tokenization messages」，它比单靠情绪词汇更接近机构研报的工作方式：
