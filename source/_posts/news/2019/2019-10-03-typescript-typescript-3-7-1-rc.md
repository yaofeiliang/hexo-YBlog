---
title: "[技术观察] TypeScript TypeScript 3.7.1 RC：把发布说明读成可执行的检查单"
date: 2019-10-25 09:00:00
updated: 2019-10-25 09:00:00
description: "TypeScript 于 2019-10-25 发布 TypeScript 3.7.1 RC。结合官方条目、场景推演与升级检查，帮你判断要不要跟、怎么跟。"
...
又一条值得记账的发布：TypeScript TypeScript 3.7.1 RC（2019-10-25）。标题可以热闹，决策还是得冷静。
...
一手入口在这里：<https://github.com/microsoft/TypeScript/releases/tag/v3.7-rc>
...
| --- | --- |
| 工具 / 项目 | TypeScript |
| 发布名称 | TypeScript 3.7.1 RC |
| 版本标签 | v3.7-rc |
| 原始发布日期 | 2019-10-25 |
| 是否预发布 | 否（正式发布版本） |
| 仓库 | microsoft/TypeScript |
| 官方发布页 | [查看原文](https://github.com/microsoft/TypeScript/releases/tag/v3.7-rc) |
...
- **官方原文：** Visual Studio Marketplace (Select new version in project options)
...
对 TypeScript（TypeScript 3.7.1 RC / v3.7-rc），建议按下列层面对齐阅读，而不是只扫版本号：
