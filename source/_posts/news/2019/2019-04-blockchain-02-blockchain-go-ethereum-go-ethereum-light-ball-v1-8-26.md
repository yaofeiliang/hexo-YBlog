---
title: "[行业观察] go-ethereum Light Ball (v1.8.26)：热闹背后的规则变化"
date: 2019-04-10 10:00:00
updated: 2019-04-10 10:00:00
description: "区块链领域关键节点：go-ethereum Light Ball (v1.8.26)。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2019/blockchain-blockchain-go-ethereum-go-ethereum-light-ball-v1-8-26/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/ethereum/go-ethereum/releases/tag/v1.8.26
source_published: 2019-04-10
...
go-ethereum 在 **2019-04-10** 留下了一条可核对的公开记录：**go-ethereum Light Ball (v1.8.26)**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2019-04-10
- **主体：** go-ethereum
- **事件：** go-ethereum Light Ball (v1.8.26)
- **一手入口：** [点这里看原文](https://github.com/ethereum/go-ethereum/releases/tag/v1.8.26)

根据可核验公开材料，关键信息可以概括为：

- Geth v1.8.26 is a tiny light client DoS hotfix.
- We've dropped support for les/1 on master (v1.9.0 unstable) and after some light servers updated, v1.8.x light clients started crashing.
- Turned out that les/2 on the v1.8.x release family relied on some les/1 throttling data (19437).
...
- 原始日期：2019-04-10
- 收录月份：2019-04
- 一手链接：<https://github.com/ethereum/go-ethereum/releases/tag/v1.8.26>
