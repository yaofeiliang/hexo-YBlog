---
title: "[行业观察] Solana Sultans v0.21.5：热闹背后的规则变化"
date: 2019-12-19 10:00:00
updated: 2019-12-19 10:00:00
description: "区块链领域关键节点：Solana Sultans v0.21.5。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2019/blockchain-blockchain-solana-solana-sultans-v0-21-5/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v0.21.5
source_published: 2019-12-19
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 Solana Sultans v0.21.5。

Solana 在 **2019-12-19** 留下了一条可核对的公开记录：**Solana Sultans v0.21.5**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2019-12-19
- **主体：** Solana
- **事件：** Solana Sultans v0.21.5
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v0.21.5)

根据可核验公开材料，关键信息可以概括为：

- solana show-validators now only displays unstaked validators that are actively voting
- Add solana-watchtower program for monitoring cluster and/or individual validator health
- Fixed bug causing multiple account notifications over RPC pubsub
- Added solana show-block-production command
...
- 原始日期：2019-12-19
- 收录月份：2019-12
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v0.21.5>
