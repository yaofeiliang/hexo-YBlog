...
source_url: https://github.com/pytorch/pytorch/releases/tag/v1.3.1
source_published: 2019-11-07
...
PyTorch 在 **2019-11-07** 留下了一条可核对的公开记录：**PyTorch Bug Fix Release**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **一手入口：** [点这里看原文](https://github.com/pytorch/pytorch/releases/tag/v1.3.1)
...
- 原始日期：2019-11-07
- 收录月份：2019-11
- 一手链接：<https://github.com/pytorch/pytorch/releases/tag/v1.3.1>
