---
title: "[行业观察] Solana Tour de SOL Stage 1, Bring it：比行情截图更值得读的部分"
date: 2019-10-28 10:00:00
updated: 2019-10-28 10:00:00
description: "区块链｜Solana Tour de SOL Stage 1, Bring it。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2019/blockchain-solana-solana-tour-de-sol-stage-1-bring-it/
categories:
  - 资讯
tags:
  - 行业资讯
...
Solana 在 **2019-10-28** 留下可核对记录：**Solana Tour de SOL Stage 1, Bring it**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 一手入口 | [阅读原文](https://github.com/solana-labs/solana/releases/tag/v0.20.0) |
| 收录月 | 2019-10 |
...
- **公开信息：** TPS 📈! Average TPS has been improved 2x over the v0.19.0 release, with GPU-based testnets now well over 50k average TPS
...
- **公开信息：** Added solana CLI commands: get-epoch, show-validators, show-stake-history
...
- **公开信息：** https://github.com/solana-labs/solana/issues/6578 - Move support is not enabled by in release binaries or testnets, it currently must be built from source.
- **阅读提醒：** 能力扩展信号：先判断它解决的是产品瓶颈、工程效率还是可观测性，再排优先级。
...
对「Solana Tour de SOL Stage 1, Bring it」做专业诊断时，先定位它主要改写的是结构、激励，还是约束。三者抓错，后续讨论会全程错位。

请用下面的分析骨架阅读「Solana Tour de SOL Stage 1, Bring it」，它比单靠情绪词汇更接近机构研报的工作方式：
