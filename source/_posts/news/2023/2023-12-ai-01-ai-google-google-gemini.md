---
title: "[行业观察] Google 发布 Gemini：这次更新到底动了谁的奶酪"
date: 2023-12-06 10:00:00
updated: 2023-12-06 10:00:00
description: "人工智能领域关键节点：Google 发布 Gemini。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2023/ai-ai-google-google-gemini/
categories:
  - 资讯
tags:
  - 行业资讯
...
又到了把咖啡放下、把官方链接点开的时刻：Google 发布 Gemini。

Google 在 **2023-12-06** 留下了一条可核对的公开记录：**Google 发布 Gemini**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **主体：** Google
- **事件：** Google 发布 Gemini
- **一手入口：** [点这里看原文](https://blog.google/technology/ai/google-gemini-ai/)

根据可核验公开材料，关键信息可以概括为：

- 原生多模态 generational 模型
- 与 Bard / 云产品衔接
- 对标 GPT-4 系列
