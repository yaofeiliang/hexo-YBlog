---
title: "[行业观察] go-ethereum Carbonaceous (v1.13.5)：热闹背后的规则变化"
date: 2023-11-14 10:00:00
updated: 2023-11-14 10:00:00
description: "区块链领域关键节点：go-ethereum Carbonaceous (v1.13.5)。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2023/blockchain-blockchain-go-ethereum-go-ethereum-carbonaceous-v1-13-5/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/ethereum/go-ethereum/releases/tag/v1.13.5
source_published: 2023-11-14
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 go-ethereum Carbonaceous (v1.13.5)。

go-ethereum 在 **2023-11-14** 留下了一条可核对的公开记录：**go-ethereum Carbonaceous (v1.13.5)**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2023-11-14
- **主体：** go-ethereum
- **事件：** go-ethereum Carbonaceous (v1.13.5)
- **一手入口：** [点这里看原文](https://github.com/ethereum/go-ethereum/releases/tag/v1.13.5)

根据可核验公开材料，关键信息可以概括为：

- Extend ethclient and the simulated backend to allow ethcall against specific block hashes (28084).
...
- 原始日期：2023-11-14
- 收录月份：2023-11
- 一手链接：<https://github.com/ethereum/go-ethereum/releases/tag/v1.13.5>
