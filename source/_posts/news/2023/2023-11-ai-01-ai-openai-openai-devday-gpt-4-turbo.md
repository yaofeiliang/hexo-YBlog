---
title: "[行业观察] OpenAI 举办首届 DevDay 并发布 GPT-4 Turbo 等：这次更新到底动了谁的奶酪"
date: 2023-11-06 10:00:00
updated: 2023-11-06 10:00:00
description: "人工智能领域关键节点：OpenAI 举办首届 DevDay 并发布 GPT-4 Turbo 等。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2023/ai-ai-openai-openai-devday-gpt-4-turbo/
categories:
  - 资讯
tags:
  - 行业资讯
...
如果说 AI 是一场连续剧，那么「OpenAI 举办首届 DevDay 并发布 GPT-4 Turbo 等」就是那集人人都在刷弹幕的高潮。

OpenAI 在 **2023-11-06** 留下了一条可核对的公开记录：**OpenAI 举办首届 DevDay 并发布 GPT-4 Turbo 等**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **一手入口：** [点这里看原文](https://openai.com/index/new-models-and-developer-products-announced-at-devday/)

根据可核验公开材料，关键信息可以概括为：

- 更长上下文与更低价格叙事
- GPTs 与 Assistants 方向
- 开发者平台感增强
