---
title: "[行业观察] go-ethereum Erszbat (v1.11.5)：热闹背后的规则变化"
date: 2023-03-21 10:00:00
updated: 2023-03-21 10:00:00
description: "区块链领域关键节点：go-ethereum Erszbat (v1.11.5)。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2023/blockchain-blockchain-go-ethereum-go-ethereum-erszbat-v1-11-5/
categories:
  - 资讯
tags:
  - 行业资讯
...
go-ethereum 在 **2023-03-21** 留下了一条可核对的公开记录：**go-ethereum Erszbat (v1.11.5)**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **一手入口：** [点这里看原文](https://github.com/ethereum/go-ethereum/releases/tag/v1.11.5)
