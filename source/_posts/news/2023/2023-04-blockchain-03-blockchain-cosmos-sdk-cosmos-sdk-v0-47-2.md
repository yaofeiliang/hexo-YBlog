---
title: "[行业观察] Cosmos SDK v0.47.2：热闹背后的规则变化"
date: 2023-04-27 10:00:00
updated: 2023-04-27 10:00:00
description: "区块链领域关键节点：Cosmos SDK v0.47.2。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2023/blockchain-blockchain-cosmos-sdk-cosmos-sdk-v0-47-2/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/cosmos/cosmos-sdk/releases/tag/v0.47.2
source_published: 2023-04-27
...
链上故事最怕两种声音：一种只喊“要上天”，一种只喊“要归零”。Cosmos SDK v0.47.2 属于第三种：值得把规则读完。

Cosmos SDK 在 **2023-04-27** 留下了一条可核对的公开记录：**Cosmos SDK v0.47.2**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2023-04-27
- **主体：** Cosmos SDK
- **事件：** Cosmos SDK v0.47.2
- **一手入口：** [点这里看原文](https://github.com/cosmos/cosmos-sdk/releases/tag/v0.47.2)

根据可核验公开材料，关键信息可以概括为：

- Cosmos SDK v0.47.2 Release Notes 💬 Release Discussion 📝 Changelog Check out the changelog for an exhaustive list of changes or compare changes from last release.
- Refer to the upgrading guide when migrating from v0.46.x to v0.47.0.
- 🚀 Highlights For this second patch release of the v0.47.x line, we focused on fixing bugs and improving the developer experience.
...
- 原始日期：2023-04-27
- 收录月份：2023-04
- 一手链接：<https://github.com/cosmos/cosmos-sdk/releases/tag/v0.47.2>
