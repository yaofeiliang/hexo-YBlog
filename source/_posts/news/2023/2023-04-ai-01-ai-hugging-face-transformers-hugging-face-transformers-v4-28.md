---
title: "[行业观察] Hugging Face Transformers v4.28.0: LLaMa, Pix2Struct, MatCha, DePlot, MEGA, NLLB-MoE, GPTBigCode：这次更新到底动了谁的奶酪"
date: 2023-04-13 10:00:00
updated: 2023-04-13 10:00:00
description: "人工智能领域关键节点：Hugging Face Transformers v4.28.0: LLaMa, Pix2Struct, MatCha, DePlot, MEGA, NLLB-MoE, GPTBigCode。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2023/ai-ai-hugging-face-transformers-hugging-face-transformers-v4-28/
categories:
  - 资讯
tags:
  - 行业资讯
...
ai_generated: false
source_count: 1
historical_period: 2023-04
source_url: https://github.com/huggingface/transformers/releases/tag/v4.28.0
source_published: 2023-04-13
...
如果说 AI 是一场连续剧，那么「Hugging Face Transformers v4.28.0: LLaMa, Pix2Struct, MatCha, DePlot, MEGA, NLLB-MoE, GPTBigCode」就是那集人人都在刷弹幕的高潮。

Hugging Face Transformers 在 **2023-04-13** 留下了一条可核对的公开记录：**Hugging Face Transformers v4.28.0: LLaMa, Pix2Struct, MatCha, DePlot, MEGA, NLLB-MoE, GPTBigCode**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **事件：** Hugging Face Transformers v4.28.0: LLaMa, Pix2Struct, MatCha, DePlot, MEGA, NLLB-MoE, GPTBigCode
- **一手入口：** [点这里看原文](https://github.com/huggingface/transformers/releases/tag/v4.28.0)
...
- 原始日期：2023-04-13
- 收录月份：2023-04
- 一手链接：<https://github.com/huggingface/transformers/releases/tag/v4.28.0>

## 来源与声明

- 本文是对官方公开信息的后期整理，不代表姚飞亮在 2023-04 已在本站发表本文。
