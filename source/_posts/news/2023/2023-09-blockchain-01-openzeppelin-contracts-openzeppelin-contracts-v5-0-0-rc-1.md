---
title: "[行业观察] OpenZeppelin Contracts v5.0.0-rc.1：把链上黑话翻译成人话"
date: 2023-09-28 10:00:00
updated: 2023-09-28 10:00:00
description: "区块链｜OpenZeppelin Contracts v5.0.0-rc.1。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2023/blockchain-openzeppelin-contracts-openzeppelin-contracts-v5-0-0-rc-1/
categories:
  - 资讯
tags:
  - 行业资讯
...
OpenZeppelin Contracts 在 **2023-09-28** 留下可核对记录：**OpenZeppelin Contracts v5.0.0-rc.1**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 一手入口 | [阅读原文](https://github.com/OpenZeppelin/openzeppelin-contracts/releases/tag/v5.0.0-rc.1) |
| 收录月 | 2023-09 |
...
- **公开信息：** Upgradeable Contracts: No longer transpile interfaces, libraries, and stateless contracts. (4636)
...
- **公开信息：** AccessManager, AccessManaged, GovernorTimelockAccess: Ensure that calldata shorter than 4 bytes is not padded to 4 bytes. (4624)
...
- **公开信息：** AccessManager: Use named return parameters in functions that return multiple values. (4624)
- **阅读提醒：** 把它当作待核验的工程信号：回到模块、配置键与调用链，确认是否命中你们的依赖图。
...
请用下面的分析骨架阅读「OpenZeppelin Contracts v5.0.0-rc.1」，它比单靠情绪词汇更接近机构研报的工作方式：
