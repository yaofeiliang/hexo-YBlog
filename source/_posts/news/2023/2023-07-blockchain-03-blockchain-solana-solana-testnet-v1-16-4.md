---
title: "[行业观察] Solana Testnet - v1.16.4：热闹背后的规则变化"
date: 2023-07-14 10:00:00
updated: 2023-07-14 10:00:00
description: "区块链领域关键节点：Solana Testnet - v1.16.4。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2023/blockchain-blockchain-solana-solana-testnet-v1-16-4/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v1.16.4
source_published: 2023-07-14
...
链上故事最怕两种声音：一种只喊“要上天”，一种只喊“要归零”。Solana Testnet - v1.16.4 属于第三种：值得把规则读完。

Solana 在 **2023-07-14** 留下了一条可核对的公开记录：**Solana Testnet - v1.16.4**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2023-07-14
- **主体：** Solana
- **事件：** Solana Testnet - v1.16.4
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v1.16.4)
...
- v1.16: Bugfix: wouldbeleadershortlyfn period set to 1 slot instead of 20 (backport of 32468) (32469)
- v1.16: cli: fix program deployment elf verification issue (backport of 32448) (32463)
...
- 原始日期：2023-07-14
- 收录月份：2023-07
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v1.16.4>
