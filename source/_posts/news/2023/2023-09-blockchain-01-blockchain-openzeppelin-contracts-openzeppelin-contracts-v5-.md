---
title: "[行业观察] OpenZeppelin Contracts v5.0.0-rc.1：热闹背后的规则变化"
date: 2023-09-28 10:00:00
updated: 2023-09-28 10:00:00
description: "区块链领域关键节点：OpenZeppelin Contracts v5.0.0-rc.1。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
...
source_url: https://github.com/OpenZeppelin/openzeppelin-contracts/releases/tag/v5.0.0-rc.1
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 OpenZeppelin Contracts v5.0.0-rc.1。

OpenZeppelin Contracts 在 **2023-09-28** 留下了一条可核对的公开记录：**OpenZeppelin Contracts v5.0.0-rc.1**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **事件：** OpenZeppelin Contracts v5.0.0-rc.1
- **一手入口：** [点这里看原文](https://github.com/OpenZeppelin/openzeppelin-contracts/releases/tag/v5.0.0-rc.1)
...
- 原始日期：2023-09-28
- 收录月份：2023-09
- 一手链接：<https://github.com/OpenZeppelin/openzeppelin-contracts/releases/tag/v5.0.0-rc.1>
