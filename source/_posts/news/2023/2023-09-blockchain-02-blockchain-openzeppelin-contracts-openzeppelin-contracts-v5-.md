---
title: "[行业观察] OpenZeppelin Contracts v5.0.0-rc.0：热闹背后的规则变化"
date: 2023-09-19 10:00:00
updated: 2023-09-19 10:00:00
description: "区块链领域关键节点：OpenZeppelin Contracts v5.0.0-rc.0。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2023/blockchain-blockchain-openzeppelin-contracts-openzeppelin-contracts-v5-/
categories:
  - 资讯
tags:
  - 行业资讯
...
ai_generated: false
source_count: 1
historical_period: 2023-09
source_url: https://github.com/OpenZeppelin/openzeppelin-contracts/releases/tag/v5.0.0-rc.0
source_published: 2023-09-19
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 OpenZeppelin Contracts v5.0.0-rc.0。

OpenZeppelin Contracts 在 **2023-09-19** 留下了一条可核对的公开记录：**OpenZeppelin Contracts v5.0.0-rc.0**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **事件：** OpenZeppelin Contracts v5.0.0-rc.0
- **一手入口：** [点这里看原文](https://github.com/OpenZeppelin/openzeppelin-contracts/releases/tag/v5.0.0-rc.0)

根据可核验公开材料，关键信息可以概括为：

- ERC1155Receiver: Removed in favor of ERC1155Holder. (4450)
- TimelockController: Changed the role architecture to use DEFAULTADMINROLE as the admin for all roles, instead of the bespoke TIMELOCKADMINROLE that was used previously. This aligns with the general recommendation for AccessControl and makes the addition of new roles easier. Accordingly, the admin parameter and timelock will now be granted DEFAULTADMINROLE instead of TIMELOCKADMINROLE. (3799)
...
- 原始日期：2023-09-19
- 收录月份：2023-09
- 一手链接：<https://github.com/OpenZeppelin/openzeppelin-contracts/releases/tag/v5.0.0-rc.0>

## 来源与声明

- 本文是对官方公开信息的后期整理，不代表姚飞亮在 2023-09 已在本站发表本文。
