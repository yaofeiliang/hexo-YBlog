---
title: "[行业观察] Solana Testnet - v1.14.13：热闹背后的规则变化"
date: 2023-01-19 10:00:00
updated: 2023-01-19 10:00:00
description: "区块链领域关键节点：Solana Testnet - v1.14.13。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2023/blockchain-blockchain-solana-solana-testnet-v1-14-13/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v1.14.13
source_published: 2023-01-19
...
当标题开始刷屏时，成熟的读者会先问：这是升级、清算，还是监管？本次主角是 Solana Testnet - v1.14.13。

Solana 在 **2023-01-19** 留下了一条可核对的公开记录：**Solana Testnet - v1.14.13**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2023-01-19
- **主体：** Solana
- **事件：** Solana Testnet - v1.14.13
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v1.14.13)

根据可核验公开材料，关键信息可以概括为：

- Refactor - Simplify loader utils (backport 29699) (29757)
- docs: update Docusaurus to v2.2 (backport 29563) (29748)
- quic-server: demote and annotate noisy, ambiguous log message (backport 29704) (29706)
- Revert "Do not exclude failed simple vote transactions from consensus" (backport 29745) (29764)
...
- 原始日期：2023-01-19
- 收录月份：2023-01
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v1.14.13>
