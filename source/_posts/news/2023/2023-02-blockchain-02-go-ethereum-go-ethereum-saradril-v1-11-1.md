---
title: "[行业观察] go-ethereum Saradril (v1.11.1)：先看规则，再看热闹"
date: 2023-02-16 10:00:00
updated: 2023-02-16 10:00:00
description: "区块链｜go-ethereum Saradril (v1.11.1)。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2023/blockchain-go-ethereum-go-ethereum-saradril-v1-11-1/
categories:
  - 资讯
tags:
  - 行业资讯
...
go-ethereum 在 **2023-02-16** 留下可核对记录：**go-ethereum Saradril (v1.11.1)**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 一手入口 | [阅读原文](https://github.com/ethereum/go-ethereum/releases/tag/v1.11.1) |
| 收录月 | 2023-02 |
...
- **公开信息：** Make our MacOS-builds work again (26653),
...
- **公开信息：** Fix some flaws related to withdrawals (Shanghai), which were detected on zhejiang testnet (26704 [26707],(https://github.com/ethereum/go-ethereum/pull/26707)).
...
- **公开信息：** Fix an issue where geth refused to start following a partial datadir wipe 26703
- **阅读提醒：** 缺陷修复信号：把条目映射到你们是否复现过同类故障；有则收益高，无则仍建议看回归面。
...
对「go-ethereum Saradril (v1.11.1)」做专业诊断时，先定位它主要改写的是结构、激励，还是约束。三者抓错，后续讨论会全程错位。

请用下面的分析骨架阅读「go-ethereum Saradril (v1.11.1)」，它比单靠情绪词汇更接近机构研报的工作方式：
