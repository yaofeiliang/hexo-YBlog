---
title: "[行业观察] OpenZeppelin Contracts v4.0.0：热闹背后的规则变化"
date: 2021-03-24 10:00:00
updated: 2021-03-24 10:00:00
description: "区块链领域关键节点：OpenZeppelin Contracts v4.0.0。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
...
source_url: https://github.com/OpenZeppelin/openzeppelin-contracts/releases/tag/v4.0.0
source_published: 2021-03-24
...
OpenZeppelin Contracts 在 **2021-03-24** 留下了一条可核对的公开记录：**OpenZeppelin Contracts v4.0.0**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **事件：** OpenZeppelin Contracts v4.0.0
- **一手入口：** [点这里看原文](https://github.com/OpenZeppelin/openzeppelin-contracts/releases/tag/v4.0.0)

根据可核验公开材料，关键信息可以概括为：

- Now targeting the 0.8.x line of Solidity compilers. For 0.6.x (resp 0.7.x) support, use version 3.4.0 (resp 3.4.0-solc-0.7) of OpenZeppelin.
- Context: making msgData return bytes calldata instead of bytes memory (2492)
- ERC20: removed the setDecimals function and the storage slot associated to decimals. (2502)
...
- 原始日期：2021-03-24
- 收录月份：2021-03
- 一手链接：<https://github.com/OpenZeppelin/openzeppelin-contracts/releases/tag/v4.0.0>
