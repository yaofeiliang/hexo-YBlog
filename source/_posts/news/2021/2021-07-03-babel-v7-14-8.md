---
title: "[技术观察] Babel v7.14.8：编译工具链更新如何影响项目"
date: 2021-07-20 09:00:00
updated: 2021-07-20 09:00:00
description: "Babel 于 2021-07-20 发布 v7.14.8。用通俗语言梳理工具背景、官方发布说明与升级检查步骤。"
permalink: news/2021/babel-v7-14-8/
categories:
  - 资讯
tags:
  - 技术资讯
...
source_url: https://github.com/babel/babel/releases/tag/v7.14.8
source_published: 2021-07-20
...
Babel 在 **2021-07-20** 发布了 **v7.14.8**。如果你已经在项目里使用它，这条发布记录值得先收藏：它是判断“要不要升级、升级前该检查什么”的官方入口；如果你还没用过它，也可以把本文当作认识这项工具的一次入门阅读。
...
| 原始发布日期 | 2021-07-20 |
| 是否预发布 | 否（正式发布版本） |
| 官方发布页 | [查看原文](https://github.com/babel/babel/releases/tag/v7.14.8) |
...
- babel-parser
- #13088 Fix await binding error within static block (@JLHwung)
- #13531 fix: disallow computed async/get/set keyword (@JLHwung)
...
- #13548 Fix parser strictMode option (@overlookmotel)
- #13573 Fix issue to allow module block in member expression (@nme077)
...
- #12344 Fix arrow transformation when arguments is defined as variable (@snitin315)
- babel-traverse
...
- #13525 fix(babel-types): accept UnaryExpression in TSLiteralType (@colinaaa)
- #13500 Add typeParameters to tagged template visitor keys (@JLHwung)
- babel-core
- #13515 Fix config validation message typo (@jaeseokk)
- babel-cli
- #13508 fix: sync defaultextensions to babel-cli usage (@JLHwung)
...
- 原始发布日期：2021-07-20
- 收录月份：2021-07
- 发布页：<https://github.com/babel/babel/releases/tag/v7.14.8>
