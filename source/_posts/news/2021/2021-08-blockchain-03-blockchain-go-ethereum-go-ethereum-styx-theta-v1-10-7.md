---
title: "[行业观察] go-ethereum Styx Theta (v1.10.7)：热闹背后的规则变化"
date: 2021-08-12 10:00:00
updated: 2021-08-12 10:00:00
description: "区块链领域关键节点：go-ethereum Styx Theta (v1.10.7)。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2021/blockchain-blockchain-go-ethereum-go-ethereum-styx-theta-v1-10-7/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/ethereum/go-ethereum/releases/tag/v1.10.7
source_published: 2021-08-12
...
go-ethereum 在 **2021-08-12** 留下了一条可核对的公开记录：**go-ethereum Styx Theta (v1.10.7)**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2021-08-12
- **主体：** go-ethereum
- **事件：** go-ethereum Styx Theta (v1.10.7)
- **一手入口：** [点这里看原文](https://github.com/ethereum/go-ethereum/releases/tag/v1.10.7)

根据可核验公开材料，关键信息可以概括为：

- The return type for oldestBlock in ethfeeHistory was changed from decimal to hex. This is to conform to the updated spec that was released after Geth's London hard-fork release was already made. The input blockCount parameter was also updated, but there Geth will accept both hex and decimal to keep backward compatibility.
...
- Change the oldestBlock return type in ethfeeHistory to hex, accept both decimal and hex as the block count (23239, 23363).
...
- 原始日期：2021-08-12
- 收录月份：2021-08
- 一手链接：<https://github.com/ethereum/go-ethereum/releases/tag/v1.10.7>
