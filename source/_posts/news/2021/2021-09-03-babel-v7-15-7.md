...
description: "Babel 于 2021-09-17 发布 v7.15.7。用通俗语言梳理工具背景、官方发布说明与升级检查步骤。"
...
Babel 在 **2021-09-17** 发布了 **v7.15.7**。如果你已经在项目里使用它，这条发布记录值得先收藏：它是判断“要不要升级、升级前该检查什么”的官方入口；如果你还没用过它，也可以把本文当作认识这项工具的一次入门阅读。
...
| 原始发布日期 | 2021-09-17 |
| 是否预发布 | 否（正式发布版本） |
| 官方发布页 | [查看原文](https://github.com/babel/babel/releases/tag/v7.15.7) |
...
- babel-parser
- #13771 fix(babel-parser): Allow line break before assert return type (@JuniorTour)
- #13755 [estree] Fix conversion of PrivateName in MemberExpression (@nicolo-ribaudo)
- babel-standalone
- #13754 Move pipeline operator to Stage 2 (@sdegutis)
- Other

### :house: Internal

- #13767 Fix regexpu-core bundling in @babel/standalone (@nicolo-ribaudo)
- #13751 [eslint-parser] Represent static using a Keyword token (@nicolo-ribaudo)
- babel-helper-validator-identifier
- #13759 Update Identifier definitions to Unicode 14 (@JLHwung)
- babel-parser
