---
title: "[行业观察] Solana Testnet - v1.7.3：把链上黑话翻译成人话"
date: 2021-06-22 10:00:00
updated: 2021-06-22 10:00:00
description: "区块链｜Solana Testnet - v1.7.3。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2021/blockchain-solana-solana-testnet-v1-7-3/
categories:
  - 资讯
tags:
  - 行业资讯
...
Solana 在 **2021-06-22** 留下可核对记录：**Solana Testnet - v1.7.3**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 一手入口 | [阅读原文](https://github.com/solana-labs/solana/releases/tag/v1.7.3) |
| 收录月 | 2021-06 |
...
- **公开信息：** Refactors and new metrics towards improving validator startup times
...
- **公开信息：** Further tighten ContactInfo shred version checks
...
- **公开信息：** Optimize blockhash calculation
...
- **公开信息：** Better handling of slot removal during accounts scans
- **阅读提醒：** 把它当作待核验的工程信号：回到模块、配置键与调用链，确认是否命中你们的依赖图。
...
请用下面的分析骨架阅读「Solana Testnet - v1.7.3」，它比单靠情绪词汇更接近机构研报的工作方式：
