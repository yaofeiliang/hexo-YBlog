---
title: "[行业观察] Cosmos SDK Cosmovisor v1.0.0 Release：热闹背后的规则变化"
date: 2021-09-30 10:00:00
updated: 2021-09-30 10:00:00
description: "区块链领域关键节点：Cosmos SDK Cosmovisor v1.0.0 Release。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2021/blockchain-blockchain-cosmos-sdk-cosmos-sdk-cosmovisor-v1-0-0-release/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/cosmos/cosmos-sdk/releases/tag/cosmovisor/v1.0.0
source_published: 2021-09-30
...
链上故事最怕两种声音：一种只喊“要上天”，一种只喊“要归零”。Cosmos SDK Cosmovisor v1.0.0 Release 属于第三种：值得把规则读完。

Cosmos SDK 在 **2021-09-30** 留下了一条可核对的公开记录：**Cosmos SDK Cosmovisor v1.0.0 Release**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2021-09-30
- **主体：** Cosmos SDK
- **事件：** Cosmos SDK Cosmovisor v1.0.0 Release
- **一手入口：** [点这里看原文](https://github.com/cosmos/cosmos-sdk/releases/tag/cosmovisor/v1.0.0)

根据可核验公开材料，关键信息可以概括为：

- Changed default value of DAEMONRESTARTAFTERUPGRADE to true.
...
- 原始日期：2021-09-30
- 收录月份：2021-09
- 一手链接：<https://github.com/cosmos/cosmos-sdk/releases/tag/cosmovisor/v1.0.0>
