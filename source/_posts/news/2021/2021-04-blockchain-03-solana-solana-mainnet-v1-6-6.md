---
title: "[行业观察] Solana Mainnet - v1.6.6：先看规则，再看热闹"
date: 2021-04-16 10:00:00
updated: 2021-04-16 10:00:00
description: "区块链｜Solana Mainnet - v1.6.6。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2021/blockchain-solana-solana-mainnet-v1-6-6/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v1.6.6
source_published: 2021-04-16
...
Solana Mainnet - v1.6.6 这类节点，适合当成“制度/协议变更”，而不是当成心情天气。

Solana 在 **2021-04-16** 留下可核对记录：**Solana Mainnet - v1.6.6**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 时间 | 2021-04-16 |
| 主体 | Solana |
| 事件 | Solana Mainnet - v1.6.6 |
| 一手入口 | [阅读原文](https://github.com/solana-labs/solana/releases/tag/v1.6.6) |
| 收录月 | 2021-04 |
...
- **公开信息：** Gossip pull request optimizations
...
- **公开信息：** Airdrop is now available via RPC
...
- **公开信息：** Improved reliability of System account decoding
- **阅读提醒：** 把它当作待核验的工程信号：回到模块、配置键与调用链，确认是否命中你们的依赖图。
...
请用下面的分析骨架阅读「Solana Mainnet - v1.6.6」，它比单靠情绪词汇更接近机构研报的工作方式：
...
- 原始日期：2021-04-16
- 收录月份：2021-04
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v1.6.6>
