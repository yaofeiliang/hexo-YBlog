---
title: "[行业观察] Solana Mainnet - v1.8.5：比行情截图更值得读的部分"
date: 2021-11-17 10:00:00
updated: 2021-11-17 10:00:00
description: "区块链｜Solana Mainnet - v1.8.5。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2021/blockchain-solana-solana-mainnet-v1-8-5/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v1.8.5
...
Solana 在 **2021-11-17** 留下可核对记录：**Solana Mainnet - v1.8.5**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 时间 | 2021-11-17 |
| 主体 | Solana |
| 事件 | Solana Mainnet - v1.8.5 |
| 一手入口 | [阅读原文](https://github.com/solana-labs/solana/releases/tag/v1.8.5) |
| 收录月 | 2021-11 |
...
- **公开信息：** Remove accounts storecached throttle, collect metrics
...
- **公开信息：** Validator: add --no-os-network-stats-reporting option
...
- **公开信息：** Fix BPF parameter alignment to work on non-x8664
...
对「Solana Mainnet - v1.8.5」做专业诊断时，先定位它主要改写的是结构、激励，还是约束。三者抓错，后续讨论会全程错位。

请用下面的分析骨架阅读「Solana Mainnet - v1.8.5」，它比单靠情绪词汇更接近机构研报的工作方式：
...
- 原始日期：2021-11-17
- 收录月份：2021-11
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v1.8.5>
