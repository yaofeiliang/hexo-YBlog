---
title: "[行业观察] Solana Testnet - v1.9.1：先看规则，再看热闹"
date: 2021-12-16 10:00:00
updated: 2021-12-16 10:00:00
description: "区块链｜Solana Testnet - v1.9.1。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2021/blockchain-solana-solana-testnet-v1-9-1/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v1.9.1
...
Solana 在 **2021-12-16** 留下可核对记录：**Solana Testnet - v1.9.1**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 时间 | 2021-12-16 |
| 主体 | Solana |
| 事件 | Solana Testnet - v1.9.1 |
| 一手入口 | [阅读原文](https://github.com/solana-labs/solana/releases/tag/v1.9.1) |
| 收录月 | 2021-12 |
...
- **公开信息：** Fix solana withdraw-from-vote-account ALL regression
...
- **公开信息：** Improve sdk source compatibility with 1.8.x
- **阅读提醒：** 把它当作待核验的工程信号：回到模块、配置键与调用链，确认是否命中你们的依赖图。
...
- **公开信息：** Add option accountsdb-plugin-config to test-validator (@fanatid)
...
- **公开信息：** Add solana-test-validator --acccount feature (@losman0s)
- **阅读提醒：** 能力扩展信号：先判断它解决的是产品瓶颈、工程效率还是可观测性，再排优先级。
- **我想追问的：** 生效时间是立刻、分阶段，还是仍在征求意见？
- **可执行翻译：** 把该点写进团队周报的“外部变量”一栏，并指定一位核对人。
...
- **公开信息：** solana-program: Remove the 5 integer msg! form for consistency and avoidance of hard to debug compile-time failures
...
对「Solana Testnet - v1.9.1」做专业诊断时，先定位它主要改写的是结构、激励，还是约束。三者抓错，后续讨论会全程错位。

请用下面的分析骨架阅读「Solana Testnet - v1.9.1」，它比单靠情绪词汇更接近机构研报的工作方式：
...
- 原始日期：2021-12-16
- 收录月份：2021-12
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v1.9.1>
