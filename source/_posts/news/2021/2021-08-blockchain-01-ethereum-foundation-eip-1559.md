---
title: "[行业观察] 以太坊伦敦升级（含 EIP-1559）：升级、托管与退出路径"
date: 2021-08-05 10:00:00
updated: 2021-08-05 10:00:00
description: "区块链｜以太坊伦敦升级（含 EIP-1559）。结合一手来源、场景推演与可执行跟进步骤，尽量读完有收获。"
permalink: news/2021/blockchain-ethereum-foundation-eip-1559/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://blog.ethereum.org/2021/07/15/london-mainnet-announcement
source_published: 2021-08-05
...
以太坊伦敦升级（含 EIP-1559） 这类节点，适合当成“制度/协议变更”，而不是当成心情天气。

Ethereum Foundation 在 **2021-08-05** 留下可核对记录：**以太坊伦敦升级（含 EIP-1559）**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
| 事件 | 以太坊伦敦升级（含 EIP-1559） |
| 一手入口 | [阅读原文](https://blog.ethereum.org/2021/07/15/london-mainnet-announcement) |
| 收录月 | 2021-08 |
...
请用下面的分析骨架阅读「以太坊伦敦升级（含 EIP-1559）」，它比单靠情绪词汇更接近机构研报的工作方式：
...
- 原始日期：2021-08-05
- 收录月份：2021-08
- 一手链接：<https://blog.ethereum.org/2021/07/15/london-mainnet-announcement>
