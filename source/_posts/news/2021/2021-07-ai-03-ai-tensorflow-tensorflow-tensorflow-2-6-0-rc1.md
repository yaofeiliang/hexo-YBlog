---
title: "[行业观察] TensorFlow TensorFlow 2.6.0-rc1：这次更新到底动了谁的奶酪"
date: 2021-07-13 10:00:00
updated: 2021-07-13 10:00:00
description: "人工智能领域关键节点：TensorFlow TensorFlow 2.6.0-rc1。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2021/ai-ai-tensorflow-tensorflow-tensorflow-2-6-0-rc1/
categories:
  - 资讯
tags:
  - 行业资讯
...
ai_generated: false
source_count: 1
historical_period: 2021-07
source_url: https://github.com/tensorflow/tensorflow/releases/tag/v2.6.0-rc1
...
又到了把咖啡放下、把官方链接点开的时刻：TensorFlow TensorFlow 2.6.0-rc1。

TensorFlow 在 **2021-07-13** 留下了一条可核对的公开记录：**TensorFlow TensorFlow 2.6.0-rc1**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **时间：** 2021-07-13
- **主体：** TensorFlow
- **事件：** TensorFlow TensorFlow 2.6.0-rc1
- **一手入口：** [点这里看原文](https://github.com/tensorflow/tensorflow/releases/tag/v2.6.0-rc1)

根据可核验公开材料，关键信息可以概括为：

- tf.train.experimental.enablemixedprecisiongraphrewrite is removed, as the API only works in graph mode and is not customizable. The function is still accessible under tf.compat.v1.mixedprecision.enablemixedprecisiongraphrewrite, but it is recommended to use the Keras mixed precision API instead.
- tf.lite:
- Remove experimental.nn.dynamicrnn, experimental.nn.TfLiteRNNCell and experimental.nn.TfLiteLSTMCell since they're no longersupported. It's recommended to just use keras lstm instead.
...
- 原始日期：2021-07-13
- 收录月份：2021-07
- 一手链接：<https://github.com/tensorflow/tensorflow/releases/tag/v2.6.0-rc1>

## 来源与声明

- 本文是对官方公开信息的后期整理，不代表姚飞亮在 2021-07 已在本站发表本文。
