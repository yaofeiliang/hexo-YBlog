---
title: "[行业观察] Solana Testnet - v1.9.2：热闹背后的规则变化"
date: 2021-12-22 10:00:00
updated: 2021-12-22 10:00:00
description: "区块链领域关键节点：Solana Testnet - v1.9.2。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2021/blockchain-blockchain-solana-solana-testnet-v1-9-2/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/solana-labs/solana/releases/tag/v1.9.2
...
Solana 在 **2021-12-22** 留下了一条可核对的公开记录：**Solana Testnet - v1.9.2**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2021-12-22
- **主体：** Solana
- **事件：** Solana Testnet - v1.9.2
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v1.9.2)

根据可核验公开材料，关键信息可以概括为：

- Fix bank hash mismatch regression (21397)
- Fix computemeterconsumption bug that could cause overflow before Transaction wide compute cap is activated
...
- 原始日期：2021-12-22
- 收录月份：2021-12
- 一手链接：<https://github.com/solana-labs/solana/releases/tag/v1.9.2>
