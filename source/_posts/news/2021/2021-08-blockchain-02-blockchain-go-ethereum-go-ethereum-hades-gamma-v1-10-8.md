---
title: "[行业观察] go-ethereum Hades Gamma (v1.10.8)：热闹背后的规则变化"
date: 2021-08-24 10:00:00
updated: 2021-08-24 10:00:00
description: "区块链领域关键节点：go-ethereum Hades Gamma (v1.10.8)。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2021/blockchain-blockchain-go-ethereum-go-ethereum-hades-gamma-v1-10-8/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/ethereum/go-ethereum/releases/tag/v1.10.8
source_published: 2021-08-24
...
链上故事最怕两种声音：一种只喊“要上天”，一种只喊“要归零”。go-ethereum Hades Gamma (v1.10.8) 属于第三种：值得把规则读完。

go-ethereum 在 **2021-08-24** 留下了一条可核对的公开记录：**go-ethereum Hades Gamma (v1.10.8)**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **时间：** 2021-08-24
- **主体：** go-ethereum
- **事件：** go-ethereum Hades Gamma (v1.10.8)
- **一手入口：** [点这里看原文](https://github.com/ethereum/go-ethereum/releases/tag/v1.10.8)
...
- 原始日期：2021-08-24
- 收录月份：2021-08
- 一手链接：<https://github.com/ethereum/go-ethereum/releases/tag/v1.10.8>
