---
title: "[行业观察] PyTorch PyTorch 1.9 Release, including Torch.Linalg and Mobile Interpreter：这次更新到底动了谁的奶酪"
date: 2021-06-15 10:00:00
updated: 2021-06-15 10:00:00
description: "人工智能领域关键节点：PyTorch PyTorch 1.9 Release, including Torch.Linalg and Mobile Interpreter。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2021/ai-ai-pytorch-pytorch-pytorch-1-9-release-including-torch-linal/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/pytorch/pytorch/releases/tag/v1.9.0
source_published: 2021-06-15
...
PyTorch 在 **2021-06-15** 留下了一条可核对的公开记录：**PyTorch PyTorch 1.9 Release, including Torch.Linalg and Mobile Interpreter**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **时间：** 2021-06-15
- **主体：** PyTorch
- **事件：** PyTorch PyTorch 1.9 Release, including Torch.Linalg and Mobile Interpreter
- **一手入口：** [点这里看原文](https://github.com/pytorch/pytorch/releases/tag/v1.9.0)
...
- 原始日期：2021-06-15
- 收录月份：2021-06
- 一手链接：<https://github.com/pytorch/pytorch/releases/tag/v1.9.0>
