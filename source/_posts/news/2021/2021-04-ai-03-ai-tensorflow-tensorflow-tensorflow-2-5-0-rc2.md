---
title: "[行业观察] TensorFlow TensorFlow 2.5.0-rc2：这次更新到底动了谁的奶酪"
date: 2021-04-27 10:00:00
updated: 2021-04-27 10:00:00
description: "人工智能领域关键节点：TensorFlow TensorFlow 2.5.0-rc2。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2021/ai-ai-tensorflow-tensorflow-tensorflow-2-5-0-rc2/
categories:
  - 资讯
tags:
  - 行业资讯
...
source_url: https://github.com/tensorflow/tensorflow/releases/tag/v2.5.0-rc2
...
又到了把咖啡放下、把官方链接点开的时刻：TensorFlow TensorFlow 2.5.0-rc2。

TensorFlow 在 **2021-04-27** 留下了一条可核对的公开记录：**TensorFlow TensorFlow 2.5.0-rc2**。AI 圈从不停，但真正值得停下来看一眼的节点通常会改写工具、成本和想象力。
...
- **时间：** 2021-04-27
- **主体：** TensorFlow
- **事件：** TensorFlow TensorFlow 2.5.0-rc2
- **一手入口：** [点这里看原文](https://github.com/tensorflow/tensorflow/releases/tag/v2.5.0-rc2)

根据可核验公开材料，关键信息可以概括为：

- Support for Python3.9 has been added.
- TPU embedding support
- Added profiledatadirectory to EmbeddingConfigSpec intpuestimatorembedding.py. This allows embedding lookup statistics gathered at runtime to be used in embedding layer partitioning decisions.
...
- 原始日期：2021-04-27
- 收录月份：2021-04
- 一手链接：<https://github.com/tensorflow/tensorflow/releases/tag/v2.5.0-rc2>
