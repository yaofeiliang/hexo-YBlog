---
title: "[行业观察] Solana Mainnet - v1.8.5：热闹背后的规则变化"
date: 2021-11-17 10:00:00
updated: 2021-11-17 10:00:00
description: "区块链领域关键节点：Solana Mainnet - v1.8.5。用风趣但可核验的方式拆开发生了什么、为什么重要、普通人怎么跟。"
permalink: news/2021/blockchain-blockchain-solana-solana-mainnet-v1-8-5/
categories:
  - 资讯
tags:
  - 行业资讯
...
Solana 在 **2021-11-17** 留下了一条可核对的公开记录：**Solana Mainnet - v1.8.5**。链上世界热闹时像夜市，冷静时像工地——真正值钱的，常常是升级、清算和规则变化。
...
- **一手入口：** [点这里看原文](https://github.com/solana-labs/solana/releases/tag/v1.8.5)

根据可核验公开材料，关键信息可以概括为：

- Remove accounts storecached throttle, collect metrics
- Validator: add --no-os-network-stats-reporting option
- Fix BPF parameter alignment to work on non-x8664
